...
class TextMesh(py4godot_primitivemesh.PrimitiveMesh):
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(154, ())
      self._ptr = None
  @staticmethod
  ...
  def text(self,  value:'str'):
    self.set_text(value)
  @property
  def font(self) -> typing.Union['py4godot_font.Font','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_fontfile.FontFile']:
    r''''''
    _ret = self. get_font()
    return _ret
  @font.setter
  ...
  @functools.native_method
  def get_font(self) -> typing.Union['py4godot_font.Font','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_fontfile.FontFile']:
    r''''''
