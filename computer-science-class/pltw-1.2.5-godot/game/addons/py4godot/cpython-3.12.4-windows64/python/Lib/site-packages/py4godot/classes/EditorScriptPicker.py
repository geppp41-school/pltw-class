...
from py4godot.wrappers.wrappers import CPPEditorScriptPickerWrapper


class EditorScriptPicker(py4godot_editorresourcepicker.EditorResourcePicker):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = EditorScriptPicker.construct_without_init()
    class_._ptr = constructor(310,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorScriptPicker.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorScriptPickerWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(310,0, ())


  def generate_wrapper(self):
    return CPPEditorScriptPickerWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = EditorScriptPicker.__new__(EditorScriptPicker)
  ...
  def cast(other:'Object'):
    ...
    cls = EditorScriptPicker.construct_without_init()
    cls._ptr = CPPEditorScriptPickerWrapper()
  ...
  @property
  def script_owner(self) -> typing.Any:
    r''''''
    _ret = self. get_script_owner()
    return _ret
  @script_owner.setter
  def script_owner(self,  value:'py4godot_object.Object'):
    self.set_script_owner(value)
  @functools.native_method
  def set_script_owner(self, owner_node:'py4godot_node.Node'   ) -> None:
    r''''''

    assert(not owner_node is None)
    assert isinstance(owner_node, get_class('Node')), 'owner_node must be Node'


    self.py__script_owner = owner_node
    ...
    self._ptr.call_with_return(454,tuple([owner_node._ptr]))

  @functools.native_method
  def get_script_owner(self) -> typing.Any:
    r''''''
...
register_cast_function('EditorScriptPicker', EditorScriptPicker.cast)
register_class('EditorScriptPicker', EditorScriptPicker)
