...
from py4godot.wrappers.wrappers import CPPNavigationAgent3DWrapper


class NavigationAgent3D(py4godot_node.Node):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = NavigationAgent3D.construct_without_init()
    class_._ptr = constructor(495,0, ())
    return class_
  @staticmethod
  def new():
    class_ = NavigationAgent3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPNavigationAgent3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(495,0, ())


  def generate_wrapper(self):
    return CPPNavigationAgent3DWrapper()
  ...
  def construct_without_init():
    cls = NavigationAgent3D.__new__(NavigationAgent3D)
  ...
  def cast(other:'Object'):
    ...
    cls = NavigationAgent3D.construct_without_init()
    cls._ptr = CPPNavigationAgent3DWrapper()
  ...
  @property
  def target_position(self) -> typing.Union['Vector3']:
    r''''''
    _ret = self. get_target_position()
    return _ret
  @target_position.setter
  def target_position(self,  value:'Vector3'):
  ...
  @property
  def path_height_offset(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_path_height_offset()
    return _ret
  @path_height_offset.setter
  def path_height_offset(self,  value:'float'):
    self.set_path_height_offset(value)
  @property
  ...
  @property
  def velocity(self) -> typing.Union['Vector3']:
    r''''''
  ...
  @property
  def use_3d_avoidance(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_use_3d_avoidance()
    return _ret
  @use_3d_avoidance.setter
  def use_3d_avoidance(self,  value:'bool'):
    self.set_use_3d_avoidance(value)
  @property
  def keep_y_velocity(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_keep_y_velocity()
    return _ret
  @keep_y_velocity.setter
  def keep_y_velocity(self,  value:'bool'):
    self.set_keep_y_velocity(value)
  @property
  ...
  def set_height(self, height:'float'   ) -> None:
    ...
    self._ptr.call_with_return(189,tuple([height]))
  ...
  def set_path_height_offset(self, path_height_offset:'float'   ) -> None:
    ...
    assert isinstance(path_height_offset, (int, float)), 'path_height_offset must be int or float'


    self.py__path_height_offset = path_height_offset
    ...
    self._ptr.call_with_return(191,tuple([path_height_offset]))

  @functools.native_method
  def get_path_height_offset(self) -> typing.Union[float]:
    r''''''
  ...
  def set_use_3d_avoidance(self, enabled:'bool'   ) -> None:
    ...
    self.py__use_3d_avoidance = enabled
    ...
    self._ptr.call_with_return(193,tuple([enabled]))

  @functools.native_method
  def get_use_3d_avoidance(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_keep_y_velocity(self, enabled:'bool'   ) -> None:
    ...
    self.py__keep_y_velocity = enabled
    ...
    self._ptr.call_with_return(195,tuple([enabled]))

  @functools.native_method
  def get_keep_y_velocity(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_neighbor_distance(self, neighbor_distance:'float'   ) -> None:
    ...
    self._ptr.call_with_return(197,tuple([neighbor_distance]))
  ...
  def set_max_neighbors(self, max_neighbors:'int'   ) -> None:
    ...
    self._ptr.call_with_return(199,tuple([max_neighbors]))
  ...
  def set_time_horizon_agents(self, time_horizon:'float'   ) -> None:
    ...
    self._ptr.call_with_return(201,tuple([time_horizon]))
  ...
  def set_time_horizon_obstacles(self, time_horizon:'float'   ) -> None:
    ...
    self._ptr.call_with_return(203,tuple([time_horizon]))
  ...
  def set_max_speed(self, max_speed:'float'   ) -> None:
    ...
    self._ptr.call_with_return(205,tuple([max_speed]))
  ...
  def set_path_max_distance(self, max_speed:'float'   ) -> None:
    ...
    self._ptr.call_with_return(207,tuple([max_speed]))
  ...
  def set_navigation_layers(self, navigation_layers:'int'   ) -> None:
    ...
    self._ptr.call_with_return(209,tuple([navigation_layers]))
  ...
  def set_navigation_layer_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(211,tuple([layer_number, value]))
  ...
  def get_navigation_layer_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(212,tuple([layer_number]))
    return _ret
  ...
  def set_pathfinding_algorithm(self, pathfinding_algorithm:'int'  ) -> None:
    ...
    self._ptr.call_with_return(213,tuple([pathfinding_algorithm]))
  ...
  def set_path_postprocessing(self, path_postprocessing:'int'  ) -> None:
    ...
    self._ptr.call_with_return(215,tuple([path_postprocessing]))
  ...
  def set_path_metadata_flags(self, flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(217,tuple([flags]))
  ...
  def set_navigation_map(self, navigation_map:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(219,tuple([navigation_map._ptr]))
  ...
  def get_navigation_map(self) -> typing.Union['RID']:
    ...
    _ret = RID.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(220,tuple([]))
    return _ret
  ...
  def set_target_position(self, position:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(221,tuple([position._ptr]))

  @functools.native_method
  def get_target_position(self) -> typing.Union['Vector3']:
    r''''''
  ...
  def set_simplify_path(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(223,tuple([enabled]))
  ...
  def set_simplify_epsilon(self, epsilon:'float'   ) -> None:
    ...
    self._ptr.call_with_return(225,tuple([epsilon]))
  ...
  def set_path_return_max_length(self, length:'float'   ) -> None:
    ...
    self._ptr.call_with_return(227,tuple([length]))
  ...
  def set_path_return_max_radius(self, radius:'float'   ) -> None:
    ...
    self._ptr.call_with_return(229,tuple([radius]))
  ...
  def set_path_search_max_polygons(self, max_polygons:'int'   ) -> None:
    ...
    self._ptr.call_with_return(231,tuple([max_polygons]))
  ...
  def set_path_search_max_distance(self, distance:'float'   ) -> None:
    ...
    self._ptr.call_with_return(233,tuple([distance]))
  ...
  @functools.native_method
  def get_next_path_position(self) -> typing.Union['Vector3']:
    r'''
  ...
  def set_velocity_forced(self, velocity:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(237,tuple([velocity._ptr]))
  ...
  def set_velocity(self, velocity:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(238,tuple([velocity._ptr]))

  @functools.native_method
  def get_velocity(self) -> typing.Union['Vector3']:
    r''''''
  ...
  @functools.native_method
  def get_current_navigation_result(self) -> typing.Union['py4godot_navigationpathqueryresult3d.NavigationPathQueryResult3D']:
    r'''
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: NavigationPathQueryResult3D
    _ret._ptr = self._ptr.call_with_return(241,tuple([]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_current_navigation_path(self) -> typing.Union['PackedVector3Array']:
    r'''
  ...
  @functools.native_method
  def get_final_position(self) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(247,tuple([]))
    return _ret
  ...
  def set_avoidance_layers(self, layers:'int'   ) -> None:
    ...
    self._ptr.call_with_return(248,tuple([layers]))
  ...
  def set_avoidance_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(250,tuple([mask]))
  ...
  def set_avoidance_layer_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(252,tuple([layer_number, value]))
  ...
  def get_avoidance_layer_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(253,tuple([layer_number]))
    return _ret
  ...
  def set_avoidance_mask_value(self, mask_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(254,tuple([mask_number, value]))
  ...
  def get_avoidance_mask_value(self, mask_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(255,tuple([mask_number]))
    return _ret
  ...
  def set_avoidance_priority(self, priority:'float'   ) -> None:
    ...
    self._ptr.call_with_return(256,tuple([priority]))
  ...
  def set_debug_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(258,tuple([enabled]))
  ...
  def set_debug_use_custom(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(260,tuple([enabled]))
  ...
  def set_debug_path_custom_color(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(262,tuple([color._ptr]))
  ...
  def set_debug_path_custom_point_size(self, point_size:'float'   ) -> None:
    ...
    self._ptr.call_with_return(264,tuple([point_size]))
...
register_cast_function('NavigationAgent3D', NavigationAgent3D.cast)
register_class('NavigationAgent3D', NavigationAgent3D)
