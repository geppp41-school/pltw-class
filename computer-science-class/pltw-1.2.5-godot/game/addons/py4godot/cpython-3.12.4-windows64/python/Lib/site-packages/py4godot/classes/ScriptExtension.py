...
'''
  ...
  @functools.native_method
  def _get_base_script(self) -> typing.Union['py4godot_gdscript.GDScript','py4godot_script.Script','typing.Self']:
    r'''
'''
...
'''
  ...
  @functools.native_method
  def _get_language(self) -> typing.Union['py4godot_scriptlanguageextension.ScriptLanguageExtension','py4godot_scriptlanguage.ScriptLanguage']:
    r'''
'''
