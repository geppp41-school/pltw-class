...
from py4godot.wrappers.wrappers import CPPPhysicsServer3DManagerWrapper

_PhysicsServer3DManager_singleton_instance = None

class PhysicsServer3DManager(py4godot_object.Object):
  r'''
  ...
  def generate_wrapper(self):
    return CPPPhysicsServer3DManagerWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsServer3DManager.__new__(PhysicsServer3DManager)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsServer3DManager.construct_without_init()
    cls._ptr = CPPPhysicsServer3DManagerWrapper()
  ...
  @staticmethod
  def instance():
    global _PhysicsServer3DManager_singleton_instance
    if _PhysicsServer3DManager_singleton_instance is None:
      singleton = PhysicsServer3DManager()
      singleton._ptr = constructor(609,0, ())
      _PhysicsServer3DManager_singleton_instance = singleton
    return _PhysicsServer3DManager_singleton_instance
...
register_cast_function('PhysicsServer3DManager', PhysicsServer3DManager.cast)
register_class('PhysicsServer3DManager', PhysicsServer3DManager)
