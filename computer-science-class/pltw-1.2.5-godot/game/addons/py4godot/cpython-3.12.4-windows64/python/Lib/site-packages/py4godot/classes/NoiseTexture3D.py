...
from py4godot.wrappers.wrappers import CPPNoiseTexture3DWrapper


class NoiseTexture3D(py4godot_texture3d.Texture3D):
  r''''''

  @staticmethod
  def constructor():
    class_ = NoiseTexture3D.construct_without_init()
    class_._ptr = constructor(520,0, ())
    return class_
  @staticmethod
  def new():
    class_ = NoiseTexture3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPNoiseTexture3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(520,0, ())


  def generate_wrapper(self):
    return CPPNoiseTexture3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = NoiseTexture3D.__new__(NoiseTexture3D)
  ...
  def cast(other:'Object'):
    ...
    cls = NoiseTexture3D.construct_without_init()
    cls._ptr = CPPNoiseTexture3DWrapper()
  ...
  @property
  def noise(self) -> typing.Union['py4godot_noise.Noise','py4godot_fastnoiselite.FastNoiseLite']:
    r''''''
    _ret = self. get_noise()
    return _ret
  @noise.setter
  ...
  def set_width(self, width:'int'   ) -> None:
    ...
    self._ptr.call_with_return(90,tuple([width]))
  ...
  def set_height(self, height:'int'   ) -> None:
    ...
    self._ptr.call_with_return(91,tuple([height]))
  ...
  def set_depth(self, depth:'int'   ) -> None:
    ...
    self._ptr.call_with_return(92,tuple([depth]))
  ...
  def set_noise(self, noise:'py4godot_noise.Noise'   ) -> None:
    ...
    self._ptr.call_with_return(93,tuple([noise._ptr]))

  @functools.native_method
  def get_noise(self) -> typing.Union['py4godot_noise.Noise','py4godot_fastnoiselite.FastNoiseLite']:
    r''''''
  ...
  def set_color_ramp(self, gradient:'py4godot_gradient.Gradient'   ) -> None:
    ...
    self._ptr.call_with_return(95,tuple([gradient._ptr]))
  ...
  def set_seamless(self, seamless:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(97,tuple([seamless]))
  ...
  def set_invert(self, invert:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(99,tuple([invert]))
  ...
  def set_normalize(self, normalize:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(101,tuple([normalize]))
  ...
  def set_seamless_blend_skirt(self, seamless_blend_skirt:'float'   ) -> None:
    ...
    self._ptr.call_with_return(103,tuple([seamless_blend_skirt]))
...
register_cast_function('NoiseTexture3D', NoiseTexture3D.cast)
register_class('NoiseTexture3D', NoiseTexture3D)
