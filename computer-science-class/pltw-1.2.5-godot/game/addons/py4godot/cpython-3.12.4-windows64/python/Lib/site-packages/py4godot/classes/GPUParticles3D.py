...
from py4godot.wrappers.wrappers import CPPGPUParticles3DWrapper
...
class GPUParticles3D(py4godot_geometryinstance3d.GeometryInstance3D):
  r'''
	...
	'''
  MAX_DRAW_PASSES:typing.ClassVar[int]

  @staticmethod
  def constructor():
    class_ = GPUParticles3D.construct_without_init()
    class_._ptr = constructor(365,0, ())
    return class_
  @staticmethod
  def new():
    class_ = GPUParticles3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPGPUParticles3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(365,0, ())


  def generate_wrapper(self):
    return CPPGPUParticles3DWrapper()
  ...
  def construct_without_init():
    cls = GPUParticles3D.__new__(GPUParticles3D)
  ...
  def cast(other:'Object'):
    ...
    cls = GPUParticles3D.construct_without_init()
    cls._ptr = CPPGPUParticles3DWrapper()
  ...
  @property
  def visibility_aabb(self) -> typing.Union['AABB']:
    r''''''
    _ret = self. get_visibility_aabb()
    return _ret
  @visibility_aabb.setter
  def visibility_aabb(self,  value:'AABB'):
  ...
  @property
  def transform_align(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_transform_align()
    return _ret
  @transform_align.setter
  def transform_align(self,  value:'int'):
    self.set_transform_align(value)
  @property
  ...
  @property
  def draw_passes(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_draw_passes()
    return _ret
  @draw_passes.setter
  def draw_passes(self,  value:'int'):
    self.set_draw_passes(value)
  @property
  def draw_pass_1(self) -> typing.Any:
    r''''''
    _ret = self. get_draw_pass_mesh(0)
    return _ret
  @draw_pass_1.setter
  def draw_pass_1(self,  value:'py4godot_object.Object'):
    self.set_draw_pass_mesh(value)
  @property
  def draw_pass_2(self) -> typing.Any:
    r''''''
    _ret = self. get_draw_pass_mesh(1)
    return _ret
  @draw_pass_2.setter
  def draw_pass_2(self,  value:'py4godot_object.Object'):
    self.set_draw_pass_mesh(value)
  @property
  def draw_pass_3(self) -> typing.Any:
    r''''''
    _ret = self. get_draw_pass_mesh(2)
    return _ret
  @draw_pass_3.setter
  def draw_pass_3(self,  value:'py4godot_object.Object'):
    self.set_draw_pass_mesh(value)
  @property
  def draw_pass_4(self) -> typing.Any:
    r''''''
    _ret = self. get_draw_pass_mesh(3)
    return _ret
  @draw_pass_4.setter
  def draw_pass_4(self,  value:'py4godot_object.Object'):
    self.set_draw_pass_mesh(value)
  @property
  def draw_skin(self) -> typing.Union['py4godot_skin.Skin']:
    r''''''
    _ret = self. get_skin()
    return _ret
  @draw_skin.setter
  def draw_skin(self,  value:'py4godot_object.Object'):
    self.set_skin(value)
  ...
  def set_emitting(self, emitting:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(298,tuple([emitting]))
  ...
  def set_amount(self, amount:'int'   ) -> None:
    ...
    self._ptr.call_with_return(299,tuple([amount]))
  ...
  def set_lifetime(self, secs:'float'   ) -> None:
    ...
    self._ptr.call_with_return(300,tuple([secs]))
  ...
  def set_one_shot(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(301,tuple([enable]))
  ...
  def set_pre_process_time(self, secs:'float'   ) -> None:
    ...
    self._ptr.call_with_return(302,tuple([secs]))
  ...
  def set_explosiveness_ratio(self, ratio:'float'   ) -> None:
    ...
    self._ptr.call_with_return(303,tuple([ratio]))
  ...
  def set_randomness_ratio(self, ratio:'float'   ) -> None:
    ...
    self._ptr.call_with_return(304,tuple([ratio]))
  ...
  def set_visibility_aabb(self, aabb:'AABB'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([aabb._ptr]))
  ...
  def set_fixed_fps(self, fps:'int'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([fps]))
  ...
  def set_fractional_delta(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(308,tuple([enable]))
  ...
  def set_interpolate(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(309,tuple([enable]))
  ...
  def set_process_material(self, material:'py4godot_material.Material'   ) -> None:
    ...
    self._ptr.call_with_return(310,tuple([material._ptr]))
  ...
  def set_speed_scale(self, scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([scale]))
  ...
  def set_collision_base_size(self, size:'float'   ) -> None:
    ...
    self._ptr.call_with_return(312,tuple([size]))
  ...
  def set_interp_to_end(self, interp:'float'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([interp]))
  ...
  @functools.native_method
  def get_visibility_aabb(self) -> typing.Union['AABB']:
    r''''''
  ...
  def set_use_fixed_seed(self, use_fixed_seed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(330,tuple([use_fixed_seed]))
  ...
  def set_seed(self, seed:'int'   ) -> None:
    ...
    self._ptr.call_with_return(332,tuple([seed]))
  ...
  def set_draw_order(self, order:'int'  ) -> None:
    ...
    self._ptr.call_with_return(334,tuple([order]))
  ...
  def set_draw_passes(self, passes:'int'   ) -> None:
    ...
    assert isinstance(passes, (int, float)), 'passes must be int or float'


    self.py__draw_passes = passes
    ...
    self._ptr.call_with_return(336,tuple([passes]))

  @functools.native_method
  def set_draw_pass_mesh(self, pass_:'int'   , mesh:'py4godot_mesh.Mesh'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(337,tuple([pass_, mesh._ptr]))

  @functools.native_method
  def get_draw_passes(self) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def get_draw_pass_mesh(self, pass_:'int'   ) -> typing.Any:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(339,tuple([pass_]))
  ...
  def set_skin(self, skin:'py4godot_skin.Skin'   ) -> None:
    ...
    self._ptr.call_with_return(340,tuple([skin._ptr]))
  ...
  def restart(self, keep_seed:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(342,tuple([keep_seed]))

  @functools.native_method
  def capture_aabb(self) -> typing.Union['AABB']:
    r'''
  ...
  def set_sub_emitter(self, path:'object'   ) -> None:
    ...
    self._ptr.call_with_return(344,tuple([py_nodepath_path._ptr]))
  ...
  def emit_particle(self, xform:'Transform3D'   , velocity:'Vector3'   , color:'Color'   , custom:'Color'   , flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(346,tuple([xform._ptr, velocity._ptr, color._ptr, custom._ptr, flags]))
  ...
  def set_trail_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(347,tuple([enabled]))
  ...
  def set_trail_lifetime(self, secs:'float'   ) -> None:
    ...
    self._ptr.call_with_return(348,tuple([secs]))
  ...
  @functools.native_method
  def set_transform_align(self, align:'int'  ) -> None:
    r''''''

    assert isinstance(align, (int, float)), 'align must be int or float'


    self.py__transform_align = align
    ...
    self._ptr.call_with_return(351,tuple([align]))

  @functools.native_method
  def get_transform_align(self) -> typing.Union[int]:
    r''''''
  ...
  def request_particles_process(self, process_time:'float'   ) -> None:
    ...
    self._ptr.call_with_return(356,tuple([process_time]))


register_cast_function('GPUParticles3D', GPUParticles3D.cast)
register_class('GPUParticles3D', GPUParticles3D)
