...
class AudioEffect(py4godot_resource.Resource):
  ...
  def _instantiate(self) -> typing.Union['py4godot_audioeffectspectrumanalyzerinstance.AudioEffectSpectrumAnalyzerInstance','py4godot_audioeffectinstance.AudioEffectInstance']:
    r'''
