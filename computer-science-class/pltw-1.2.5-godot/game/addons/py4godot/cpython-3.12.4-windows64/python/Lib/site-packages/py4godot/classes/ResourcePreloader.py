...
from py4godot.wrappers.wrappers import CPPResourcePreloaderWrapper


class ResourcePreloader(py4godot_node.Node):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = ResourcePreloader.construct_without_init()
    class_._ptr = constructor(706,0, ())
    return class_
  @staticmethod
  def new():
    class_ = ResourcePreloader.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPResourcePreloaderWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(706,0, ())


  def generate_wrapper(self):
    return CPPResourcePreloaderWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = ResourcePreloader.__new__(ResourcePreloader)
  ...
  def cast(other:'Object'):
    ...
    cls = ResourcePreloader.construct_without_init()
    cls._ptr = CPPResourcePreloaderWrapper()
  ...
  @property
  def resources(self) -> typing.Union['Array']:
    r''''''
    _ret = self. _get_resources()
    return _ret
  @resources.setter
  def resources(self,  value:'Array'):
    self._set_resources(value)
  @functools.native_method
  def add_resource(self, name:'object'   , resource:'py4godot_resource.Resource'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(180,tuple([py_stringname_name._ptr, resource._ptr]))

  @functools.native_method
  def remove_resource(self, name:'object'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(181,tuple([py_stringname_name._ptr]))

  @functools.native_method
  def rename_resource(self, name:'object'   , newname:'object'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(182,tuple([py_stringname_name._ptr, py_stringname_newname._ptr]))

  @functools.native_method
  def has_resource(self, name:'object'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(183,tuple([py_stringname_name._ptr]))
    return _ret


  @functools.native_method
  def get_resource(self, name:'object'   ) -> typing.Any:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(184,tuple([py_stringname_name._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_resource_list(self) -> typing.Union['PackedStringArray']:
    r'''
...
register_cast_function('ResourcePreloader', ResourcePreloader.cast)
register_class('ResourcePreloader', ResourcePreloader)
