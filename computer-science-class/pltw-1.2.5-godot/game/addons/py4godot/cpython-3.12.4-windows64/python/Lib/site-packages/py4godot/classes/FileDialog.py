...
class FileDialog(py4godot_confirmationdialog.ConfirmationDialog):
  ...
  def hidden_files_toggle_enabled(self,  value:'bool'):
    self.set_customization_flag_enabled(value)
  @property
  ...
  def set_customization_flag_enabled(self, flag:'int'  , enabled:'bool'   ) -> None:
    r'''
				Toggles the specified customization `flag`, allowing to customize features available in this `FileDialog`. See `enum Customization` for options.
			'''
