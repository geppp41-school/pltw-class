...
from py4godot.wrappers.wrappers import CPPPhysicsDirectBodyState2DExtensionWrapper


class PhysicsDirectBodyState2DExtension(py4godot_physicsdirectbodystate2d.PhysicsDirectBodyState2D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsDirectBodyState2DExtension.construct_without_init()
    class_._ptr = constructor(592,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsDirectBodyState2DExtension.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsDirectBodyState2DExtensionWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(592,0, ())


  def generate_wrapper(self):
    return CPPPhysicsDirectBodyState2DExtensionWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsDirectBodyState2DExtension.__new__(PhysicsDirectBodyState2DExtension)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsDirectBodyState2DExtension.construct_without_init()
    cls._ptr = CPPPhysicsDirectBodyState2DExtensionWrapper()
  ...
  def _get_total_gravity(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def _get_center_of_mass(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def _get_center_of_mass_local(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def _get_inverse_inertia(self) -> typing.Union[float]:
    r'''
  ...
  def _set_linear_velocity(self, velocity:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(104,tuple([velocity._ptr]))

  @functools.native_method
  def _get_linear_velocity(self) -> typing.Union['Vector2']:
    r'''
  ...
  def _set_angular_velocity(self, velocity:'float'   ) -> None:
    ...
    self._ptr.call_with_return(106,tuple([velocity]))

  @functools.native_method
  def _get_angular_velocity(self) -> typing.Union[float]:
    r'''
  ...
  def _set_transform(self, transform:'Transform2D'   ) -> None:
    ...
    self._ptr.call_with_return(108,tuple([transform._ptr]))

  @functools.native_method
  def _get_transform(self) -> typing.Union['Transform2D']:
    r'''
  ...
  @functools.native_method
  def _get_velocity_at_local_position(self, local_position:'Vector2'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(110,tuple([local_position._ptr]))
    return _ret
  ...
  def _apply_central_impulse(self, impulse:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(111,tuple([impulse._ptr]))
  ...
  def _apply_impulse(self, impulse:'Vector2'   , position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(112,tuple([impulse._ptr, position._ptr]))
  ...
  def _apply_torque_impulse(self, impulse:'float'   ) -> None:
    ...
    self._ptr.call_with_return(113,tuple([impulse]))
  ...
  def _apply_central_force(self, force:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(114,tuple([force._ptr]))
  ...
  def _apply_force(self, force:'Vector2'   , position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(115,tuple([force._ptr, position._ptr]))
  ...
  def _apply_torque(self, torque:'float'   ) -> None:
    ...
    self._ptr.call_with_return(116,tuple([torque]))
  ...
  def _add_constant_central_force(self, force:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(117,tuple([force._ptr]))
  ...
  def _add_constant_force(self, force:'Vector2'   , position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(118,tuple([force._ptr, position._ptr]))
  ...
  def _add_constant_torque(self, torque:'float'   ) -> None:
    ...
    self._ptr.call_with_return(119,tuple([torque]))
  ...
  def _set_constant_force(self, force:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(120,tuple([force._ptr]))

  @functools.native_method
  def _get_constant_force(self) -> typing.Union['Vector2']:
    r'''
  ...
  def _set_constant_torque(self, torque:'float'   ) -> None:
    ...
    self._ptr.call_with_return(122,tuple([torque]))

  @functools.native_method
  def _get_constant_torque(self) -> typing.Union[float]:
    r'''
  ...
  def _set_sleep_state(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(124,tuple([enabled]))
...
'''
    ...
    self._ptr.call_with_return(126,tuple([layer]))
...
'''
    ...
    self._ptr.call_with_return(128,tuple([mask]))
...
'''
  ...
  @functools.native_method
  def _get_contact_local_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(131,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_local_normal(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(132,tuple([contact_idx]))
    return _ret
  ...
  def _get_contact_local_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(133,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_local_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(134,tuple([contact_idx]))
    return _ret
  ...
  @functools.native_method
  def _get_contact_collider_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
  ...
  def _get_contact_collider_id(self, contact_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(137,tuple([contact_idx]))
    return _ret
  ...
  def _get_contact_collider_object(self, contact_idx:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(138,tuple([contact_idx]))
  ...
  def _get_contact_collider_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(139,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_collider_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def _get_contact_impulse(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def _get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate2d.PhysicsDirectSpaceState2D','py4godot_physicsdirectspacestate2dextension.PhysicsDirectSpaceState2DExtension']:
    r'''
...
register_cast_function('PhysicsDirectBodyState2DExtension', PhysicsDirectBodyState2DExtension.cast)
register_class('PhysicsDirectBodyState2DExtension', PhysicsDirectBodyState2DExtension)
