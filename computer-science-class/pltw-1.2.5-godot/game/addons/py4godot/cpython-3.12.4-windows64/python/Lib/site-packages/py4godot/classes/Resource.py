...
from py4godot.wrappers.wrappers import CPPResourceWrapper

class DeepDuplicateMode:
  DEEP_DUPLICATE_NONE = 0
  DEEP_DUPLICATE_INTERNAL = 1
  DEEP_DUPLICATE_ALL = 2


class Resource(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = Resource.construct_without_init()
    class_._ptr = constructor(685,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Resource.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPResourceWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(685,0, ())


  def generate_wrapper(self):
    return CPPResourceWrapper()
  def init_signals(self):
    super().init_signals()
    changed_name = utils.py_string_to_string_name("changed")
    self.changed = signals.BuiltinSignal(self, changed_name)
    setup_local_to_scene_requested_name = utils.py_string_to_string_name("setup_local_to_scene_requested")
    self.setup_local_to_scene_requested = signals.BuiltinSignal(self, setup_local_to_scene_requested_name)

  @staticmethod
  def construct_without_init():
    cls = Resource.__new__(Resource)
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(77, ())
      self._ptr = None
  @staticmethod
  def cast(other:'Object'):
    assert other != None # Object to be casted must not be None
    cls = Resource.construct_without_init()
    cls._ptr = CPPResourceWrapper()
  ...
  @property
  def resource_local_to_scene(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_local_to_scene()
    return _ret
  @resource_local_to_scene.setter
  def resource_local_to_scene(self,  value:'bool'):
    self.set_local_to_scene(value)
  @property
  def resource_path(self) -> typing.Union[str]:
    r''''''
    _ret = self. get_path()
    return _ret
  @resource_path.setter
  def resource_path(self,  value:'str'):
    self.set_path(value)
  @property
  def resource_name(self) -> typing.Union[str]:
    r''''''
    _ret = self. get_name()
    return _ret
  ...
  def resource_name(self,  value:'str'):
    self.set_name(value)
  @property
  def resource_scene_unique_id(self) -> typing.Union[str]:
    r''''''
    _ret = self. get_scene_unique_id()
    return _ret
  @resource_scene_unique_id.setter
  def resource_scene_unique_id(self,  value:'str'):
    self.set_scene_unique_id(value)
  ...
  @functools.native_method
  def _get_rid(self) -> typing.Union['RID']:
    r'''
  ...
  def _set_path_cache(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(56,tuple([py_string_path._ptr]))
  ...
  def set_path(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(57,tuple([py__string_path._ptr]))
  ...
  def take_over_path(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([py_string_path._ptr]))
  ...
  def set_path_cache(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(60,tuple([py_string_path._ptr]))
  ...
  def set_name(self, name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(61,tuple([py__string_name._ptr]))
  ...
  def set_local_to_scene(self, enable:'bool'   ) -> None:
    ...
    self.py__resource_local_to_scene = enable
    ...
    self._ptr.call_with_return(64,tuple([enable]))

  @functools.native_method
  def is_local_to_scene(self) -> typing.Union[bool]:
    r''''''
  ...
  @functools.native_method
  def get_local_scene(self) -> typing.Any:
    r'''
  ...
  def set_id_for_path(self, path:'str'   , id:'str'   ) -> None:
    ...
    self._ptr.call_with_return(69,tuple([py_string_path._ptr, py_string_id._ptr]))

  @functools.native_method
  def get_id_for_path(self, path:'str'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(70,tuple([py_string_path._ptr]))
    return utils.gd_string_to_py_string(_ret)


  @functools.native_method
  def is_built_in(self) -> typing.Union[bool]:
    r'''
  ...
  @staticmethod
  def generate_scene_unique_id() -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(685,0,tuple([]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def set_scene_unique_id(self, id:'str'   ) -> None:
    ...
    self.py__resource_scene_unique_id = id
    ...
    py__string_id = utils.py_string_to_string(id)
    py__string_id.shouldBeDeleted = False


    self._ptr.call_with_return(72,tuple([py__string_id._ptr]))

  @functools.native_method
  def get_scene_unique_id(self) -> typing.Union[str]:
    r''''''
  ...
  @functools.native_method
  def duplicate(self, deep:'bool' =False  ) -> typing.Any:
    r'''
				...
				If `deep` is `true`, a **deep** copy is returned: all nested arrays, dictionaries, and packed arrays are also duplicated (recursively). Any `Resource` found inside will only be duplicated if it's local, like `constant DEEP_DUPLICATE_INTERNAL` used with `duplicate_deep`.
				The following exceptions apply:
				- Subresource properties with the `constant PROPERTY_USAGE_ALWAYS_DUPLICATE` flag are always duplicated (recursively or not, depending on `deep`).
    ...
    _ret = Resource.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(75,tuple([deep]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def duplicate_deep(self, deep_subresources_mode:'int'  =1) -> typing.Any:
    r'''
				Duplicates this resource, deeply, like `duplicate``(true)`, with extra control over how subresources are handled.
				`deep_subresources_mode` must be one of the values from `enum DeepDuplicateMode`.
			'''
    ...
    _ret = Resource.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(76,tuple([deep_subresources_mode]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None



register_cast_function('Resource', Resource.cast)
register_class('Resource', Resource)
