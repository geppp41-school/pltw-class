...
from py4godot.classes.core import *
from py4godot.wrappers.wrappers import CPPStringNameTypedArrayWrapper
...
class StringNameTypedArray():
  ...
  @staticmethod
  def new0():
    _class = StringNameTypedArray.construct_without_init()
    _class._ptr = constructor(48, 0, tuple([]))
    return _class
  @staticmethod
  def new1(from_:'Array' ):
    ...
    _class._ptr = constructor(48, 1, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new2(base:'Array' , type:'int' , class_name:'object' , script:'object' ):
    ...
    _class._ptr = constructor(48, 2, tuple([base._ptr, type, py_stringname_class_name._ptr, script]))
    return _class
  @staticmethod
  def new3(from_:'PackedByteArray' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 3, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new4(from_:'PackedInt32Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 4, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new5(from_:'PackedInt64Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 5, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new6(from_:'PackedFloat32Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 6, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new7(from_:'PackedFloat64Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 7, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new8(from_:'PackedStringArray' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 8, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new9(from_:'PackedVector2Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 9, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new10(from_:'PackedVector3Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 10, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new11(from_:'PackedColorArray' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 11, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new12(from_:'PackedVector4Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(48, 12, tuple([from_._ptr]))
    return _class

  def __init__(self):
    self.shouldBeDeleted = True
    self.casted_from = None
    self._ptr =  constructor(48,0, ())

  def generate_wrapper(self):
    return CPPStringNameTypedArrayWrapper()
  def init_signals(self):
    pass

  @staticmethod
  def construct_without_init():
    cls = StringNameTypedArray.__new__(StringNameTypedArray)
  ...
  def from_list(values):
    result = StringNameTypedArray.new0()
    for value in values:
  ...
  @functools.native_method
  def get(self, index:'int'   ) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def set(self, index:'int'   , value:'StringName'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def push_back(self, value:'StringName'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def push_front(self, value:'StringName'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def append(self, value:'StringName'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def insert(self, position:'int'   , value:'StringName'   ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def fill(self, value:'StringName'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def erase(self, value:'StringName'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def front(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def back(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def pick_random(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def find(self, what:'StringName'   , from_:'int' =0  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def rfind(self, what:'StringName'   , from_:'int' =-1  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def count(self, value:'StringName'   ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def has(self, value:'StringName'   ) -> typing.Union[bool]:
    r''''''
  ...
  @functools.native_method
  def pop_back(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def pop_front(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def pop_at(self, position:'int'   ) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def bsearch(self, value:'StringName'   , before:'bool' =True  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def bsearch_custom(self, value:'StringName'   , func:'Callable'   , before:'bool' =True  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def reduce(self, method:'Callable'   , accum:'StringName' = None  ) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def max(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def min(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def get_typed_script(self) -> typing.Union['StringName']:
    r''''''
