...
from py4godot.wrappers.wrappers import CPPPhysicsDirectBodyState2DWrapper


class PhysicsDirectBodyState2D(py4godot_object.Object):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsDirectBodyState2D.construct_without_init()
    class_._ptr = constructor(591,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsDirectBodyState2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsDirectBodyState2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(591,0, ())


  def generate_wrapper(self):
    return CPPPhysicsDirectBodyState2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsDirectBodyState2D.__new__(PhysicsDirectBodyState2D)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsDirectBodyState2D.construct_without_init()
    cls._ptr = CPPPhysicsDirectBodyState2DWrapper()
  ...
  def inverse_mass(self) -> typing.Union[float]:
    ...
    return _ret
  @property
  def inverse_inertia(self) -> typing.Union[float]:
    r''''''
  ...
  def total_linear_damp(self) -> typing.Union[float]:
    ...
    return _ret
  @property
  def total_gravity(self) -> typing.Union['Vector2']:
    r''''''
  ...
  def center_of_mass(self) -> typing.Union['Vector2']:
    ...
    return _ret
  @property
  def center_of_mass_local(self) -> typing.Union['Vector2']:
    r''''''
  ...
  def get_total_gravity(self) -> typing.Union['Vector2']:
    r''''''
  ...
  @functools.native_method
  def get_center_of_mass_local(self) -> typing.Union['Vector2']:
    r''''''
  ...
  @functools.native_method
  def get_inverse_inertia(self) -> typing.Union[float]:
    r''''''
  ...
  def set_linear_velocity(self, velocity:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(56,tuple([velocity._ptr]))
  ...
  def set_angular_velocity(self, velocity:'float'   ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([velocity]))
  ...
  def set_transform(self, transform:'Transform2D'   ) -> None:
    ...
    self._ptr.call_with_return(60,tuple([transform._ptr]))
  ...
  @functools.native_method
  def get_velocity_at_local_position(self, local_position:'Vector2'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(62,tuple([local_position._ptr]))
    return _ret
  ...
  def apply_central_impulse(self, impulse:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(63,tuple([impulse._ptr]))
  ...
  def apply_torque_impulse(self, impulse:'float'   ) -> None:
    ...
    self._ptr.call_with_return(64,tuple([impulse]))
  ...
  def apply_impulse(self, impulse:'Vector2'   , position:'Vector2' = None  ) -> None:
    ...
    self._ptr.call_with_return(65,tuple([impulse._ptr, position._ptr]))

  @functools.native_method
  def apply_central_force(self, force:'Vector2' = None  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(66,tuple([force._ptr]))
  ...
  def apply_force(self, force:'Vector2'   , position:'Vector2' = None  ) -> None:
    ...
    self._ptr.call_with_return(67,tuple([force._ptr, position._ptr]))
  ...
  def apply_torque(self, torque:'float'   ) -> None:
    ...
    self._ptr.call_with_return(68,tuple([torque]))

  @functools.native_method
  def add_constant_central_force(self, force:'Vector2' = None  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(69,tuple([force._ptr]))
  ...
  def add_constant_force(self, force:'Vector2'   , position:'Vector2' = None  ) -> None:
    ...
    self._ptr.call_with_return(70,tuple([force._ptr, position._ptr]))
  ...
  def add_constant_torque(self, torque:'float'   ) -> None:
    ...
    self._ptr.call_with_return(71,tuple([torque]))
  ...
  def set_constant_force(self, force:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(72,tuple([force._ptr]))
  ...
  def set_constant_torque(self, torque:'float'   ) -> None:
    ...
    self._ptr.call_with_return(74,tuple([torque]))
  ...
  def set_sleep_state(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(76,tuple([enabled]))
  ...
  def set_collision_layer(self, layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(78,tuple([layer]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(80,tuple([mask]))
  ...
  @functools.native_method
  def get_contact_local_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(83,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_local_normal(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(84,tuple([contact_idx]))
    return _ret
  ...
  def get_contact_local_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(85,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_local_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def get_contact_collider_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(88,tuple([contact_idx]))
    return _ret
  ...
  def get_contact_collider_id(self, contact_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(89,tuple([contact_idx]))
    return _ret
  ...
  def get_contact_collider_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(91,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_collider_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(92,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_impulse(self, contact_idx:'int'   ) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate2d.PhysicsDirectSpaceState2D','py4godot_physicsdirectspacestate2dextension.PhysicsDirectSpaceState2DExtension']:
    r'''
...
register_cast_function('PhysicsDirectBodyState2D', PhysicsDirectBodyState2D.cast)
register_class('PhysicsDirectBodyState2D', PhysicsDirectBodyState2D)
