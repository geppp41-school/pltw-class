...
from py4godot.wrappers.wrappers import CPPVisualShaderNodeUIntParameterWrapper


class VisualShaderNodeUIntParameter(py4godot_visualshadernodeparameter.VisualShaderNodeParameter):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = VisualShaderNodeUIntParameter.construct_without_init()
    class_._ptr = constructor(970,0, ())
    return class_
  @staticmethod
  def new():
    class_ = VisualShaderNodeUIntParameter.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPVisualShaderNodeUIntParameterWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(970,0, ())


  def generate_wrapper(self):
    return CPPVisualShaderNodeUIntParameterWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = VisualShaderNodeUIntParameter.__new__(VisualShaderNodeUIntParameter)
  ...
  def cast(other:'Object'):
    ...
    cls = VisualShaderNodeUIntParameter.construct_without_init()
    cls._ptr = CPPVisualShaderNodeUIntParameterWrapper()
...
register_cast_function('VisualShaderNodeUIntParameter', VisualShaderNodeUIntParameter.cast)
register_class('VisualShaderNodeUIntParameter', VisualShaderNodeUIntParameter)
