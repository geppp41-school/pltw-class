...
from py4godot.wrappers.wrappers import CPPVisualShaderNodeFloatParameterWrapper
...
class VisualShaderNodeFloatParameter(py4godot_visualshadernodeparameter.VisualShaderNodeParameter):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = VisualShaderNodeFloatParameter.construct_without_init()
    class_._ptr = constructor(906,0, ())
    return class_
  @staticmethod
  def new():
    class_ = VisualShaderNodeFloatParameter.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPVisualShaderNodeFloatParameterWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(906,0, ())


  def generate_wrapper(self):
    return CPPVisualShaderNodeFloatParameterWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = VisualShaderNodeFloatParameter.__new__(VisualShaderNodeFloatParameter)
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(104, ())
      self._ptr = None
  @staticmethod
  def cast(other:'Object'):
    assert other != None # Object to be casted must not be None
    cls = VisualShaderNodeFloatParameter.construct_without_init()
    cls._ptr = CPPVisualShaderNodeFloatParameterWrapper()
  ...
  def hint(self,  value:'int'):
    self.set_hint(value)
  @property
  def min(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_min()
    return _ret
  @min.setter
  def min(self,  value:'float'):
    self.set_min(value)
  @property
  def max(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_max()
    return _ret
  @max.setter
  ...
  @property
  def default_value(self) -> typing.Union[float]:
    r''''''
  ...
  def set_default_value_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(100,tuple([enabled]))
  ...
  def set_default_value(self, value:'float'   ) -> None:
    ...
    self._ptr.call_with_return(102,tuple([value]))

  @functools.native_method
  def get_default_value(self) -> typing.Union[float]:
    r''''''
...
register_cast_function('VisualShaderNodeFloatParameter', VisualShaderNodeFloatParameter.cast)
register_class('VisualShaderNodeFloatParameter', VisualShaderNodeFloatParameter)
