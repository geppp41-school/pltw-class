...
from py4godot.wrappers.wrappers import CPPCubemapArrayWrapper


class CubemapArray(py4godot_imagetexturelayered.ImageTextureLayered):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = CubemapArray.construct_without_init()
    class_._ptr = constructor(247,0, ())
    return class_
  @staticmethod
  def new():
    class_ = CubemapArray.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCubemapArrayWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(247,0, ())


  def generate_wrapper(self):
    return CPPCubemapArrayWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = CubemapArray.__new__(CubemapArray)
  ...
  def cast(other:'Object'):
    ...
    cls = CubemapArray.construct_without_init()
    cls._ptr = CPPCubemapArrayWrapper()
...
register_cast_function('CubemapArray', CubemapArray.cast)
register_class('CubemapArray', CubemapArray)
