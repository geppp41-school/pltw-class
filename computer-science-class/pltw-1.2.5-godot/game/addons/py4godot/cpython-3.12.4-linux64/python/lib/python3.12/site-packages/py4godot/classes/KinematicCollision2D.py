...
from py4godot.wrappers.wrappers import CPPKinematicCollision2DWrapper


class KinematicCollision2D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = KinematicCollision2D.construct_without_init()
    class_._ptr = constructor(444,0, ())
    return class_
  @staticmethod
  def new():
    class_ = KinematicCollision2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPKinematicCollision2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(444,0, ())


  def generate_wrapper(self):
    return CPPKinematicCollision2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = KinematicCollision2D.__new__(KinematicCollision2D)
  ...
  def cast(other:'Object'):
    ...
    cls = KinematicCollision2D.construct_without_init()
    cls._ptr = CPPKinematicCollision2DWrapper()
  ...
  @functools.native_method
  def get_angle(self, up_direction:'Vector2' = None  ) -> typing.Union[float]:
    r'''
				Returns the collision angle according to `up_direction`, which is `constant Vector2.UP` by default. This value is always positive.
			'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(57,tuple([up_direction._ptr]))
    return _ret
  ...
  @functools.native_method
  def get_local_shape(self) -> typing.Any:
    r'''
  ...
  @functools.native_method
  def get_collider_shape(self) -> typing.Any:
    r'''
  ...
  @functools.native_method
  def get_collider_shape_index(self) -> typing.Union[int]:
    r'''
...
register_cast_function('KinematicCollision2D', KinematicCollision2D.cast)
register_class('KinematicCollision2D', KinematicCollision2D)
