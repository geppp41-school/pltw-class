...
from py4godot.classes.core import *
from py4godot.wrappers.wrappers import CPPDictionaryTypedArrayWrapper
...
class DictionaryTypedArray():
  ...
  @staticmethod
  def new0():
    _class = DictionaryTypedArray.construct_without_init()
    _class._ptr = constructor(6, 0, tuple([]))
    return _class
  @staticmethod
  def new1(from_:'Array' ):
    ...
    _class._ptr = constructor(6, 1, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new2(base:'Array' , type:'int' , class_name:'object' , script:'object' ):
    ...
    _class._ptr = constructor(6, 2, tuple([base._ptr, type, py_stringname_class_name._ptr, script]))
    return _class
  @staticmethod
  def new3(from_:'PackedByteArray' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 3, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new4(from_:'PackedInt32Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 4, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new5(from_:'PackedInt64Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 5, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new6(from_:'PackedFloat32Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 6, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new7(from_:'PackedFloat64Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 7, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new8(from_:'PackedStringArray' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 8, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new9(from_:'PackedVector2Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 9, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new10(from_:'PackedVector3Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 10, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new11(from_:'PackedColorArray' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 11, tuple([from_._ptr]))
    return _class
  @staticmethod
  def new12(from_:'PackedVector4Array' ):
    ...
    _class.__from___ = from_
    _class._ptr = constructor(6, 12, tuple([from_._ptr]))
    return _class

  def __init__(self):
    self.shouldBeDeleted = True
    self.casted_from = None
    self._ptr =  constructor(6,0, ())

  def generate_wrapper(self):
    return CPPDictionaryTypedArrayWrapper()
  def init_signals(self):
    pass

  @staticmethod
  def construct_without_init():
    cls = DictionaryTypedArray.__new__(DictionaryTypedArray)
  ...
  def from_list(values):
    result = DictionaryTypedArray.new0()
    for value in values:
  ...
  @functools.native_method
  def get(self, index:'int'   ) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def set(self, index:'int'   , value:'Dictionary'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def push_back(self, value:'Dictionary'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def push_front(self, value:'Dictionary'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def append(self, value:'Dictionary'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def insert(self, position:'int'   , value:'Dictionary'   ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def fill(self, value:'Dictionary'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def erase(self, value:'Dictionary'   ) -> None:
    r''''''
  ...
  @functools.native_method
  def front(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def back(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def pick_random(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def find(self, what:'Dictionary'   , from_:'int' =0  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def rfind(self, what:'Dictionary'   , from_:'int' =-1  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def count(self, value:'Dictionary'   ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def has(self, value:'Dictionary'   ) -> typing.Union[bool]:
    r''''''
  ...
  @functools.native_method
  def pop_back(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def pop_front(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def pop_at(self, position:'int'   ) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def bsearch(self, value:'Dictionary'   , before:'bool' =True  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def bsearch_custom(self, value:'Dictionary'   , func:'Callable'   , before:'bool' =True  ) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def reduce(self, method:'Callable'   , accum:'Dictionary' = None  ) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def max(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def min(self) -> typing.Union['Dictionary']:
    r''''''
  ...
  @functools.native_method
  def get_typed_script(self) -> typing.Union['Dictionary']:
    r''''''
