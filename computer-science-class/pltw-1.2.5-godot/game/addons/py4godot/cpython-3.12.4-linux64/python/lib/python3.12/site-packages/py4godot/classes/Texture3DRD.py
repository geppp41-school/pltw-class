...
from py4godot.wrappers.wrappers import CPPTexture3DRDWrapper


class Texture3DRD(py4godot_texture3d.Texture3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = Texture3DRD.construct_without_init()
    class_._ptr = constructor(823,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Texture3DRD.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPTexture3DRDWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(823,0, ())


  def generate_wrapper(self):
    return CPPTexture3DRDWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = Texture3DRD.__new__(Texture3DRD)
  ...
  def cast(other:'Object'):
    ...
    cls = Texture3DRD.construct_without_init()
    cls._ptr = CPPTexture3DRDWrapper()
  ...
  def set_texture_rd_rid(self, texture_rd_rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(90,tuple([texture_rd_rid._ptr]))
...
register_cast_function('Texture3DRD', Texture3DRD.cast)
register_class('Texture3DRD', Texture3DRD)
