...
import py4godot.classes.RIDTypedArray as py4godot_ridtypedarray 
from py4godot.wrappers.wrappers import CPPPhysicsShapeQueryParameters3DWrapper


class PhysicsShapeQueryParameters3D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsShapeQueryParameters3D.construct_without_init()
    class_._ptr = constructor(612,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsShapeQueryParameters3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsShapeQueryParameters3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(612,0, ())


  def generate_wrapper(self):
    return CPPPhysicsShapeQueryParameters3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsShapeQueryParameters3D.__new__(PhysicsShapeQueryParameters3D)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsShapeQueryParameters3D.construct_without_init()
    cls._ptr = CPPPhysicsShapeQueryParameters3DWrapper()
  ...
  @property
  def motion(self) -> typing.Union['Vector3']:
    r''''''
    _ret = self. get_motion()
    return _ret
  @motion.setter
  def motion(self,  value:'Vector3'):
  ...
  @property
  def shape_rid(self) -> typing.Union['RID']:
    r''''''
    _ret = self. get_shape_rid()
    return _ret
  @shape_rid.setter
  def shape_rid(self,  value:'RID'):
  ...
  def set_shape(self, shape:'py4godot_resource.Resource'   ) -> None:
    r''''''

    assert(not shape is None)
    assert isinstance(shape, get_class('Resource')), 'shape must be Resource'
    ...
    self._ptr.call_with_return(53,tuple([shape._ptr]))
  ...
  def set_shape_rid(self, shape:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(55,tuple([shape._ptr]))

  @functools.native_method
  def get_shape_rid(self) -> typing.Union['RID']:
    r''''''
  ...
  def set_motion(self, motion:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(59,tuple([motion._ptr]))

  @functools.native_method
  def get_motion(self) -> typing.Union['Vector3']:
    r''''''
  ...
  def set_margin(self, margin:'float'   ) -> None:
    ...
    self._ptr.call_with_return(61,tuple([margin]))
  ...
  def set_collision_mask(self, collision_mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(63,tuple([collision_mask]))
  ...
  def set_exclude(self, exclude:'py4godot_ridtypedarray.RIDTypedArray'   ) -> None:
    ...
    self._ptr.call_with_return(65,tuple([exclude._ptr]))
...
register_cast_function('PhysicsShapeQueryParameters3D', PhysicsShapeQueryParameters3D.cast)
register_class('PhysicsShapeQueryParameters3D', PhysicsShapeQueryParameters3D)
