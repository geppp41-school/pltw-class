...
from py4godot.wrappers.wrappers import CPPCharacterBody3DWrapper
...
class CharacterBody3D(py4godot_physicsbody3d.PhysicsBody3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = CharacterBody3D.construct_without_init()
    class_._ptr = constructor(208,0, ())
    return class_
  @staticmethod
  def new():
    class_ = CharacterBody3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCharacterBody3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(208,0, ())


  def generate_wrapper(self):
    return CPPCharacterBody3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = CharacterBody3D.__new__(CharacterBody3D)
  ...
  def cast(other:'Object'):
    ...
    cls = CharacterBody3D.construct_without_init()
    cls._ptr = CPPCharacterBody3DWrapper()
  ...
  @property
  def up_direction(self) -> typing.Union['Vector3']:
    r''''''
  ...
  def set_velocity(self, velocity:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(296,tuple([velocity._ptr]))
  ...
  def set_safe_margin(self, margin:'float'   ) -> None:
    ...
    self._ptr.call_with_return(298,tuple([margin]))
  ...
  def set_floor_constant_speed_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(302,tuple([enabled]))
  ...
  def set_platform_floor_layers(self, exclude_layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(308,tuple([exclude_layer]))
  ...
  def set_platform_wall_layers(self, exclude_layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(310,tuple([exclude_layer]))
  ...
  def set_max_slides(self, max_slides:'int'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([max_slides]))
  ...
  def set_floor_max_angle(self, radians:'float'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([radians]))
  ...
  def set_floor_snap_length(self, floor_snap_length:'float'   ) -> None:
    ...
    self._ptr.call_with_return(317,tuple([floor_snap_length]))
  ...
  def set_wall_min_slide_angle(self, radians:'float'   ) -> None:
    ...
    self._ptr.call_with_return(319,tuple([radians]))

  @functools.native_method
  def get_up_direction(self) -> typing.Union['Vector3']:
    r''''''
  ...
  def set_up_direction(self, up_direction:'Vector3'   ) -> None:
    ...
    assert isinstance(up_direction, Vector3), 'up_direction must be Vector3'
    ...
    self._ptr.call_with_return(321,tuple([up_direction._ptr]))
  ...
  def set_motion_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(322,tuple([mode]))
  ...
  def set_platform_on_leave(self, on_leave_apply_velocity:'int'  ) -> None:
    ...
    self._ptr.call_with_return(324,tuple([on_leave_apply_velocity]))
  ...
  @functools.native_method
  def get_floor_normal(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_wall_normal(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_last_motion(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_position_delta(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_real_velocity(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_floor_angle(self, up_direction:'Vector3' = None  ) -> typing.Union[float]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(337,tuple([up_direction._ptr]))
    return _ret


  @functools.native_method
  def get_platform_velocity(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_platform_angular_velocity(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_slide_collision(self, slide_idx:'int'   ) -> typing.Union['py4godot_kinematiccollision3d.KinematicCollision3D']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(341,tuple([slide_idx]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_last_slide_collision(self) -> typing.Union['py4godot_kinematiccollision3d.KinematicCollision3D']:
    r'''
...
register_cast_function('CharacterBody3D', CharacterBody3D.cast)
register_class('CharacterBody3D', CharacterBody3D)
