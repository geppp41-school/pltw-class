...
from py4godot.wrappers.wrappers import CPPTexture2DWrapper


class Texture2D(py4godot_texture.Texture):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = Texture2D.construct_without_init()
    class_._ptr = constructor(818,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Texture2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPTexture2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(818,0, ())


  def generate_wrapper(self):
    return CPPTexture2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = Texture2D.__new__(Texture2D)
  ...
  def cast(other:'Object'):
    ...
    cls = Texture2D.construct_without_init()
    cls._ptr = CPPTexture2DWrapper()
  ...
  @functools.native_method
  def _is_pixel_opaque(self, x:'int'   , y:'int'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(79,tuple([x, y]))
    return _ret


  @functools.native_method
  def _has_alpha(self) -> typing.Union[bool]:
    r'''
  ...
  def _draw(self, to_canvas_item:'RID'   , pos:'Vector2'   , modulate:'Color'   , transpose:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(81,tuple([to_canvas_item._ptr, pos._ptr, modulate._ptr, transpose]))
  ...
  def _draw_rect(self, to_canvas_item:'RID'   , rect:'Rect2'   , tile:'bool'   , modulate:'Color'   , transpose:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(82,tuple([to_canvas_item._ptr, rect._ptr, tile, modulate._ptr, transpose]))
  ...
  def _draw_rect_region(self, to_canvas_item:'RID'   , rect:'Rect2'   , src_rect:'Rect2'   , modulate:'Color'   , transpose:'bool'   , clip_uv:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(83,tuple([to_canvas_item._ptr, rect._ptr, src_rect._ptr, modulate._ptr, transpose, clip_uv]))
  ...
  @functools.native_method
  def has_alpha(self) -> typing.Union[bool]:
    r'''
  ...
  @functools.native_method
  def draw(self, canvas_item:'RID'   , position:'Vector2'   , modulate:'Color' = None  , transpose:'bool' =False  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(88,tuple([canvas_item._ptr, position._ptr, modulate._ptr, transpose]))

  @functools.native_method
  def draw_rect(self, canvas_item:'RID'   , rect:'Rect2'   , tile:'bool'   , modulate:'Color' = None  , transpose:'bool' =False  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(89,tuple([canvas_item._ptr, rect._ptr, tile, modulate._ptr, transpose]))

  @functools.native_method
  def draw_rect_region(self, canvas_item:'RID'   , rect:'Rect2'   , src_rect:'Rect2'   , modulate:'Color' = None  , transpose:'bool' =False  , clip_uv:'bool' =True  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(90,tuple([canvas_item._ptr, rect._ptr, src_rect._ptr, modulate._ptr, transpose, clip_uv]))

  @functools.native_method
  def get_image(self) -> typing.Union['py4godot_image.Image']:
    r'''
...
register_cast_function('Texture2D', Texture2D.cast)
register_class('Texture2D', Texture2D)
