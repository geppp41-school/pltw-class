...
class RetargetModifier3D(py4godot_skeletonmodifier3d.SkeletonModifier3D):
  ...
  @property
  def profile(self) -> typing.Union['py4godot_skeletonprofilehumanoid.SkeletonProfileHumanoid','py4godot_skeletonprofile.SkeletonProfile']:
    r''''''
  ...
  @functools.native_method
  def get_profile(self) -> typing.Union['py4godot_skeletonprofilehumanoid.SkeletonProfileHumanoid','py4godot_skeletonprofile.SkeletonProfile']:
    r''''''
