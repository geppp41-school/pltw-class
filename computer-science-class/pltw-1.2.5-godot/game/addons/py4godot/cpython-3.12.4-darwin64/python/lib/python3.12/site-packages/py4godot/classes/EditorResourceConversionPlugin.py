...
from py4godot.wrappers.wrappers import CPPEditorResourceConversionPluginWrapper


class EditorResourceConversionPlugin(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = EditorResourceConversionPlugin.construct_without_init()
    class_._ptr = constructor(297,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorResourceConversionPlugin.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorResourceConversionPluginWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(297,0, ())


  def generate_wrapper(self):
    return CPPEditorResourceConversionPluginWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = EditorResourceConversionPlugin.__new__(EditorResourceConversionPlugin)
  ...
  def cast(other:'Object'):
    ...
    cls = EditorResourceConversionPlugin.construct_without_init()
    cls._ptr = CPPEditorResourceConversionPluginWrapper()
  ...
  def _converts_to(self) -> typing.Union[str]:
    r'''
  ...
  @functools.native_method
  def _handles(self, resource:'py4godot_resource.Resource'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(54,tuple([resource._ptr]))
    return _ret


  @functools.native_method
  def _convert(self, resource:'py4godot_resource.Resource'   ) -> typing.Any:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(55,tuple([resource._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None



register_cast_function('EditorResourceConversionPlugin', EditorResourceConversionPlugin.cast)
register_class('EditorResourceConversionPlugin', EditorResourceConversionPlugin)
