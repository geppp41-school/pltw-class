...
from py4godot.wrappers.wrappers import CPPTexture2DArrayWrapper


class Texture2DArray(py4godot_imagetexturelayered.ImageTextureLayered):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = Texture2DArray.construct_without_init()
    class_._ptr = constructor(819,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Texture2DArray.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPTexture2DArrayWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(819,0, ())


  def generate_wrapper(self):
    return CPPTexture2DArrayWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = Texture2DArray.__new__(Texture2DArray)
  ...
  def __setitem__(self,  index, value):
    self._ptr.call_with_return(96, (index, value))

  def __getitem__(self,  index):

    if index < 0:
      raise KeyError(f"Index '{index}' invalid")
    pyobject = self._ptr.call_with_return(95, (index,))
    return pyobject
  def __iter__(self):
    self._index = 0
    return self
  ...
  def cast(other:'Object'):
    ...
    cls = Texture2DArray.construct_without_init()
    cls._ptr = CPPTexture2DArrayWrapper()
...
register_cast_function('Texture2DArray', Texture2DArray.cast)
register_class('Texture2DArray', Texture2DArray)
