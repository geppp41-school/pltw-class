...
from py4godot.wrappers.wrappers import CPPAudioStreamOggVorbisWrapper


class AudioStreamOggVorbis(py4godot_audiostream.AudioStream):
  r''''''

  @staticmethod
  def constructor():
    class_ = AudioStreamOggVorbis.construct_without_init()
    class_._ptr = constructor(146,0, ())
    return class_
  @staticmethod
  def new():
    class_ = AudioStreamOggVorbis.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPAudioStreamOggVorbisWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(146,0, ())


  def generate_wrapper(self):
    return CPPAudioStreamOggVorbisWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = AudioStreamOggVorbis.__new__(AudioStreamOggVorbis)
  ...
  def cast(other:'Object'):
    ...
    cls = AudioStreamOggVorbis.construct_without_init()
    cls._ptr = CPPAudioStreamOggVorbisWrapper()
  ...
  @property
  def packet_sequence(self) -> typing.Any:
    r''''''
    _ret = self. get_packet_sequence()
    return _ret
  @packet_sequence.setter
  def packet_sequence(self,  value:'py4godot_object.Object'):
    self.set_packet_sequence(value)
  @property
  ...
  def load_from_buffer(stream_data:'PackedByteArray'   ) -> typing.Union['typing.Self']:
    ...
    _ret = AudioStreamOggVorbis.construct_without_init()
    _ret._ptr = static_method(146,1,tuple([stream_data._ptr]))
  ...
  def load_from_file(path:'str'   ) -> typing.Union['typing.Self']:
    ...
    _ret = AudioStreamOggVorbis.construct_without_init()
    _ret._ptr = static_method(146,2,tuple([py_string_path._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def set_packet_sequence(self, packet_sequence:'py4godot_oggpacketsequence.OggPacketSequence'   ) -> None:
    r''''''

    assert(not packet_sequence is None)
    assert isinstance(packet_sequence, get_class('OggPacketSequence')), 'packet_sequence must be OggPacketSequence'


    self.py__packet_sequence = packet_sequence
    ...
    self._ptr.call_with_return(93,tuple([packet_sequence._ptr]))

  @functools.native_method
  def get_packet_sequence(self) -> typing.Union['py4godot_oggpacketsequence.OggPacketSequence']:
    r''''''




    _ret = classes.Object.Object.construct_without_init() #Smart casted to: OggPacketSequence
  ...
  def set_tags(self, tags:'Dictionary'   ) -> None:
    ...
    self._ptr.call_with_return(105,tuple([tags._ptr]))
...
register_cast_function('AudioStreamOggVorbis', AudioStreamOggVorbis.cast)
register_class('AudioStreamOggVorbis', AudioStreamOggVorbis)
