...
from py4godot.wrappers.wrappers import CPPRemoteTransform2DWrapper


class RemoteTransform2D(py4godot_node2d.Node2D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = RemoteTransform2D.construct_without_init()
    class_._ptr = constructor(671,0, ())
    return class_
  @staticmethod
  def new():
    class_ = RemoteTransform2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPRemoteTransform2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(671,0, ())


  def generate_wrapper(self):
    return CPPRemoteTransform2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = RemoteTransform2D.__new__(RemoteTransform2D)
  ...
  def cast(other:'Object'):
    ...
    cls = RemoteTransform2D.construct_without_init()
    cls._ptr = CPPRemoteTransform2DWrapper()
  ...
  def set_remote_node(self, path:'object'   ) -> None:
    ...
    self._ptr.call_with_return(303,tuple([py_nodepath_path._ptr]))
  ...
  def set_use_global_coordinates(self, use_global_coordinates:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(306,tuple([use_global_coordinates]))
  ...
  def set_update_position(self, update_remote_position:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(308,tuple([update_remote_position]))
  ...
  def set_update_rotation(self, update_remote_rotation:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(310,tuple([update_remote_rotation]))
  ...
  def set_update_scale(self, update_remote_scale:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(312,tuple([update_remote_scale]))
...
register_cast_function('RemoteTransform2D', RemoteTransform2D.cast)
register_class('RemoteTransform2D', RemoteTransform2D)
