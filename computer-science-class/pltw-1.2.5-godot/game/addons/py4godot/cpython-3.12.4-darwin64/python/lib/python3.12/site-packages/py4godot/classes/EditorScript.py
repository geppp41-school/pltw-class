...
from py4godot.wrappers.wrappers import CPPEditorScriptWrapper


class EditorScript(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = EditorScript.construct_without_init()
    class_._ptr = constructor(309,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorScript.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorScriptWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(309,0, ())


  def generate_wrapper(self):
    return CPPEditorScriptWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = EditorScript.__new__(EditorScript)
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(57, ())
      self._ptr = None
  @staticmethod
  def cast(other:'Object'):
    assert other != None # Object to be casted must not be None
    cls = EditorScript.construct_without_init()
    cls._ptr = CPPEditorScriptWrapper()
  ...
  @functools.native_method
  def add_root_node(self, node:'py4godot_node.Node'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(54,tuple([node._ptr]))

  @functools.native_method
  def get_scene(self) -> typing.Any:
    r'''
...
register_cast_function('EditorScript', EditorScript.cast)
register_class('EditorScript', EditorScript)
