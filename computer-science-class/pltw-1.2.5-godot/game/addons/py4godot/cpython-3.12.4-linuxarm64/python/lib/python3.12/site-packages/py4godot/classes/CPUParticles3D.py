...
from py4godot.wrappers.wrappers import CPPCPUParticles3DWrapper
...
class CPUParticles3D(py4godot_geometryinstance3d.GeometryInstance3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = CPUParticles3D.construct_without_init()
    class_._ptr = constructor(177,0, ())
    return class_
  @staticmethod
  def new():
    class_ = CPUParticles3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCPUParticles3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(177,0, ())


  def generate_wrapper(self):
    return CPPCPUParticles3DWrapper()
  ...
  def construct_without_init():
    cls = CPUParticles3D.__new__(CPUParticles3D)
  ...
  def cast(other:'Object'):
    ...
    cls = CPUParticles3D.construct_without_init()
    cls._ptr = CPPCPUParticles3DWrapper()
  ...
  @property
  def emission_points(self) -> typing.Union['PackedVector3Array']:
    r''''''
    _ret = self. get_emission_points()
    return _ret
  @emission_points.setter
  def emission_points(self,  value:'PackedVector3Array'):
    self.set_emission_points(value)
  @property
  def emission_normals(self) -> typing.Union['PackedVector3Array']:
    r''''''
    _ret = self. get_emission_normals()
    return _ret
  @emission_normals.setter
  def emission_normals(self,  value:'PackedVector3Array'):
  ...
  @property
  def scale_curve_z(self) -> typing.Union['py4godot_curve.Curve']:
    r''''''
    _ret = self. get_scale_curve_z()
    return _ret
  @scale_curve_z.setter
  def scale_curve_z(self,  value:'py4godot_object.Object'):
    self.set_scale_curve_z(value)
  @property
  ...
  def set_lifetime_randomness(self, random:'float'   ) -> None:
    ...
    self._ptr.call_with_return(306,tuple([random]))
  ...
  def set_fixed_fps(self, fps:'int'   ) -> None:
    ...
    self._ptr.call_with_return(308,tuple([fps]))
  ...
  def set_speed_scale(self, scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(310,tuple([scale]))
  ...
  def set_draw_order(self, order:'int'  ) -> None:
    ...
    self._ptr.call_with_return(324,tuple([order]))
  ...
  def set_mesh(self, mesh:'py4godot_mesh.Mesh'   ) -> None:
    ...
    self._ptr.call_with_return(326,tuple([mesh._ptr]))
  ...
  def restart(self, keep_seed:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(332,tuple([keep_seed]))
  ...
  def request_particles_process(self, process_time:'float'   ) -> None:
    ...
    self._ptr.call_with_return(333,tuple([process_time]))
  ...
  def set_direction(self, direction:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(335,tuple([direction._ptr]))
  ...
  def set_spread(self, degrees:'float'   ) -> None:
    ...
    self._ptr.call_with_return(337,tuple([degrees]))
  ...
  def set_flatness(self, amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(339,tuple([amount]))
  ...
  @functools.native_method
  def get_emission_points(self) -> typing.Union['PackedVector3Array']:
    r''''''
  ...
  @functools.native_method
  def get_emission_normals(self) -> typing.Union['PackedVector3Array']:
    r''''''
  ...
  def set_emission_ring_axis(self, axis:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(367,tuple([axis._ptr]))
  ...
  def set_emission_ring_height(self, height:'float'   ) -> None:
    ...
    self._ptr.call_with_return(369,tuple([height]))
  ...
  def set_emission_ring_radius(self, radius:'float'   ) -> None:
    ...
    self._ptr.call_with_return(371,tuple([radius]))
  ...
  def set_emission_ring_inner_radius(self, inner_radius:'float'   ) -> None:
    ...
    self._ptr.call_with_return(373,tuple([inner_radius]))
  ...
  def set_emission_ring_cone_angle(self, cone_angle:'float'   ) -> None:
    ...
    self._ptr.call_with_return(375,tuple([cone_angle]))
  ...
  def get_emission_ring_cone_angle(self) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(376,tuple([]))
  ...
  def get_gravity(self) -> typing.Union['Vector3']:
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(377,tuple([]))
  ...
  def set_gravity(self, accel_vec:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(378,tuple([accel_vec._ptr]))
  ...
  def set_split_scale(self, split_scale:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(380,tuple([split_scale]))
  ...
  def set_scale_curve_x(self, scale_curve:'py4godot_curve.Curve'   ) -> None:
    ...
    self._ptr.call_with_return(382,tuple([scale_curve._ptr]))
  ...
  def get_scale_curve_y(self) -> typing.Union['py4godot_curve.Curve']:
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Curve
    _ret._ptr = self._ptr.call_with_return(383,tuple([]))
  ...
  def set_scale_curve_y(self, scale_curve:'py4godot_curve.Curve'   ) -> None:
    ...
    self._ptr.call_with_return(384,tuple([scale_curve._ptr]))

  @functools.native_method
  def get_scale_curve_z(self) -> typing.Union['py4godot_curve.Curve']:
    r''''''
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Curve
    _ret._ptr = self._ptr.call_with_return(385,tuple([]))

    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def set_scale_curve_z(self, scale_curve:'py4godot_curve.Curve'   ) -> None:
    r''''''
    ...
    self.py__scale_curve_z = scale_curve
    ...
    self._ptr.call_with_return(386,tuple([scale_curve._ptr]))
  ...
  def convert_from_particles(self, particles:'py4godot_node.Node'   ) -> None:
    ...
    self._ptr.call_with_return(387,tuple([particles._ptr]))


register_cast_function('CPUParticles3D', CPUParticles3D.cast)
register_class('CPUParticles3D', CPUParticles3D)
