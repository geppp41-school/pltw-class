...
from py4godot.wrappers.wrappers import CPPPhysicsTestMotionResult3DWrapper


class PhysicsTestMotionResult3D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsTestMotionResult3D.construct_without_init()
    class_._ptr = constructor(616,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsTestMotionResult3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsTestMotionResult3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(616,0, ())


  def generate_wrapper(self):
    return CPPPhysicsTestMotionResult3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsTestMotionResult3D.__new__(PhysicsTestMotionResult3D)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsTestMotionResult3D.construct_without_init()
    cls._ptr = CPPPhysicsTestMotionResult3DWrapper()
  ...
  @functools.native_method
  def get_collision_safe_fraction(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_collision_unsafe_fraction(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_collision_point(self, collision_index:'int' =0  ) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_collision_normal(self, collision_index:'int' =0  ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(59,tuple([collision_index]))
    return _ret
  ...
  def get_collider_id(self, collision_index:'int' =0  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(61,tuple([collision_index]))
    return _ret
  ...
  def get_collider_rid(self, collision_index:'int' =0  ) -> typing.Union['RID']:
    ...
    _ret._ptr = self._ptr.call_with_return(62,tuple([collision_index]))
    return _ret
  ...
  @functools.native_method
  def get_collider_shape(self, collision_index:'int' =0  ) -> typing.Union[int]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(64,tuple([collision_index]))
    return _ret


  @functools.native_method
  def get_collision_local_shape(self, collision_index:'int' =0  ) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def get_collision_depth(self, collision_index:'int' =0  ) -> typing.Union[float]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(66,tuple([collision_index]))
    return _ret



register_cast_function('PhysicsTestMotionResult3D', PhysicsTestMotionResult3D.cast)
register_class('PhysicsTestMotionResult3D', PhysicsTestMotionResult3D)
