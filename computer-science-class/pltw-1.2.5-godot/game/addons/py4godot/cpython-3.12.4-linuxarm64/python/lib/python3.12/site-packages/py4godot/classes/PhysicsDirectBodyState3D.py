...
from py4godot.wrappers.wrappers import CPPPhysicsDirectBodyState3DWrapper


class PhysicsDirectBodyState3D(py4godot_object.Object):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsDirectBodyState3D.construct_without_init()
    class_._ptr = constructor(593,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsDirectBodyState3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsDirectBodyState3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(593,0, ())


  def generate_wrapper(self):
    return CPPPhysicsDirectBodyState3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsDirectBodyState3D.__new__(PhysicsDirectBodyState3D)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsDirectBodyState3D.construct_without_init()
    cls._ptr = CPPPhysicsDirectBodyState3DWrapper()
  ...
  def step(self) -> typing.Union[float]:
    ...
    return _ret
  @property
  def inverse_mass(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_inverse_mass()
    return _ret
  @property
  def total_angular_damp(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_total_angular_damp()
    return _ret
  @property
  def total_linear_damp(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_total_linear_damp()
    return _ret
  @property
  def inverse_inertia(self) -> typing.Union['Vector3']:
    r''''''
    _ret = self. get_inverse_inertia()
    return _ret
  @property
  def inverse_inertia_tensor(self) -> typing.Union['Basis']:
    r''''''
    _ret = self. get_inverse_inertia_tensor()
    return _ret
  @property
  def total_gravity(self) -> typing.Union['Vector3']:
    r''''''
    _ret = self. get_total_gravity()
    return _ret
  @property
  def center_of_mass(self) -> typing.Union['Vector3']:
    ...
    return _ret
  @property
  def center_of_mass_local(self) -> typing.Union['Vector3']:
    r''''''
    _ret = self. get_center_of_mass_local()
    return _ret
  @property
  def principal_inertia_axes(self) -> typing.Union['Basis']:
    r''''''
    _ret = self. get_principal_inertia_axes()
    return _ret
  @property
  ...
  def get_total_gravity(self) -> typing.Union['Vector3']:
    r''''''
  ...
  @functools.native_method
  def get_total_linear_damp(self) -> typing.Union[float]:
    r''''''
  ...
  @functools.native_method
  def get_total_angular_damp(self) -> typing.Union[float]:
    r''''''
  ...
  @functools.native_method
  def get_center_of_mass_local(self) -> typing.Union['Vector3']:
    r''''''
  ...
  @functools.native_method
  def get_principal_inertia_axes(self) -> typing.Union['Basis']:
    r''''''
  ...
  @functools.native_method
  def get_inverse_mass(self) -> typing.Union[float]:
    r''''''
  ...
  @functools.native_method
  def get_inverse_inertia(self) -> typing.Union['Vector3']:
    r''''''
  ...
  def set_linear_velocity(self, velocity:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([velocity._ptr]))
  ...
  def set_transform(self, transform:'Transform3D'   ) -> None:
    ...
    self._ptr.call_with_return(62,tuple([transform._ptr]))
  ...
  @functools.native_method
  def get_velocity_at_local_position(self, local_position:'Vector3'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(64,tuple([local_position._ptr]))
    return _ret


  @functools.native_method
  def apply_central_impulse(self, impulse:'Vector3' = None  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(65,tuple([impulse._ptr]))
  ...
  def apply_impulse(self, impulse:'Vector3'   , position:'Vector3' = None  ) -> None:
    ...
    self._ptr.call_with_return(66,tuple([impulse._ptr, position._ptr]))
  ...
  def apply_torque_impulse(self, impulse:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(67,tuple([impulse._ptr]))

  @functools.native_method
  def apply_central_force(self, force:'Vector3' = None  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(68,tuple([force._ptr]))
  ...
  def apply_force(self, force:'Vector3'   , position:'Vector3' = None  ) -> None:
    ...
    self._ptr.call_with_return(69,tuple([force._ptr, position._ptr]))
  ...
  def apply_torque(self, torque:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(70,tuple([torque._ptr]))

  @functools.native_method
  def add_constant_central_force(self, force:'Vector3' = None  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(71,tuple([force._ptr]))
  ...
  def add_constant_force(self, force:'Vector3'   , position:'Vector3' = None  ) -> None:
    ...
    self._ptr.call_with_return(72,tuple([force._ptr, position._ptr]))
  ...
  def add_constant_torque(self, torque:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(73,tuple([torque._ptr]))
  ...
  def set_constant_force(self, force:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(74,tuple([force._ptr]))
  ...
  def set_constant_torque(self, torque:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(76,tuple([torque._ptr]))
  ...
  def set_collision_layer(self, layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(80,tuple([layer]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(82,tuple([mask]))
  ...
  @functools.native_method
  def get_contact_local_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(85,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_local_normal(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(86,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_impulse(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(87,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_local_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(88,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_local_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(89,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_collider(self, contact_idx:'int'   ) -> typing.Union['RID']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(90,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_collider_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(91,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_collider_id(self, contact_idx:'int'   ) -> typing.Union[int]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(92,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_collider_object(self, contact_idx:'int'   ) -> typing.Any:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(93,tuple([contact_idx]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_contact_collider_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(94,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def get_contact_collider_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(95,tuple([contact_idx]))
    return _ret
  ...
  @functools.native_method
  def get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate3d.PhysicsDirectSpaceState3D','py4godot_physicsdirectspacestate3dextension.PhysicsDirectSpaceState3DExtension']:
    r'''
...
register_cast_function('PhysicsDirectBodyState3D', PhysicsDirectBodyState3D.cast)
register_class('PhysicsDirectBodyState3D', PhysicsDirectBodyState3D)
