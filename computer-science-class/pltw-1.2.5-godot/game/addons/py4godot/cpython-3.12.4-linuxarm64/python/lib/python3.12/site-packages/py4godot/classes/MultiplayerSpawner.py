...
from py4godot.wrappers.wrappers import CPPMultiplayerSpawnerWrapper


class MultiplayerSpawner(py4godot_node.Node):
  r''''''

  @staticmethod
  def constructor():
    class_ = MultiplayerSpawner.construct_without_init()
    class_._ptr = constructor(490,0, ())
    return class_
  @staticmethod
  def new():
    class_ = MultiplayerSpawner.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPMultiplayerSpawnerWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(490,0, ())


  def generate_wrapper(self):
    return CPPMultiplayerSpawnerWrapper()
  def init_signals(self):
    super().init_signals()
    despawned_name = utils.py_string_to_string_name("despawned")
    self.despawned = signals.BuiltinSignal(self, despawned_name)
    spawned_name = utils.py_string_to_string_name("spawned")
    self.spawned = signals.BuiltinSignal(self, spawned_name)

  @staticmethod
  def construct_without_init():
    cls = MultiplayerSpawner.__new__(MultiplayerSpawner)
  ...
  def cast(other:'Object'):
    ...
    cls = MultiplayerSpawner.construct_without_init()
    cls._ptr = CPPMultiplayerSpawnerWrapper()
  ...
  @property
  def spawn_path(self) -> typing.Union['NodePath']:
    r''''''
    _ret = self. get_spawn_path()
    return _ret
  @spawn_path.setter
  def spawn_path(self,  value:'object'):
    self.set_spawn_path(value)
  @property
  def spawn_limit(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_spawn_limit()
    return _ret
  @spawn_limit.setter
  def spawn_limit(self,  value:'int'):
    self.set_spawn_limit(value)
  @property
  def spawn_function(self) -> typing.Union['Callable']:
    r''''''
    _ret = self. get_spawn_function()
    return _ret
  @spawn_function.setter
  def spawn_function(self,  value:'Callable'):
    self.set_spawn_function(value)
  ...
  def add_spawnable_scene(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(180,tuple([py_string_path._ptr]))

  @functools.native_method
  def get_spawnable_scene_count(self) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def get_spawnable_scene(self, index:'int'   ) -> typing.Union[str]:
    r''''''
    ...
    _ret._ptr = self._ptr.call_with_return(182,tuple([index]))
  ...
  @functools.native_method
  def spawn(self, data:'object' =None  ) -> typing.Any:
    r''''''
    ...
    _ret._ptr = self._ptr.call_with_return(184,tuple([data]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_spawn_path(self) -> typing.Union['NodePath']:
    r''''''
  ...
  @functools.native_method
  def set_spawn_path(self, path:'object'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(186,tuple([py_nodepath_path._ptr]))

  @functools.native_method
  def get_spawn_limit(self) -> typing.Union[int]:
    r''''''
  ...
  def set_spawn_limit(self, limit:'int'   ) -> None:
    ...
    self._ptr.call_with_return(188,tuple([limit]))

  @functools.native_method
  def get_spawn_function(self) -> typing.Union['Callable']:
    r''''''
  ...
  def set_spawn_function(self, spawn_function:'Callable'   ) -> None:
    ...
    assert(not spawn_function is None)
    assert isinstance(spawn_function, Callable), 'spawn_function must be Callable'


    self.py__spawn_function = spawn_function
    ...
    self._ptr.call_with_return(190,tuple([spawn_function._ptr]))


register_cast_function('MultiplayerSpawner', MultiplayerSpawner.cast)
register_class('MultiplayerSpawner', MultiplayerSpawner)
