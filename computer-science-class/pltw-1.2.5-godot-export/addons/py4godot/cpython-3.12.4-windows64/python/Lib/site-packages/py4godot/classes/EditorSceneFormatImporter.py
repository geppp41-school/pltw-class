...
from py4godot.wrappers.wrappers import CPPEditorSceneFormatImporterWrapper


class EditorSceneFormatImporter(py4godot_refcounted.RefCounted):
  r'''
	...
	'''
  IMPORT_SCENE:typing.ClassVar[int]

  IMPORT_ANIMATION:typing.ClassVar[int]

  IMPORT_FAIL_ON_MISSING_DEPENDENCIES:typing.ClassVar[int]

  IMPORT_GENERATE_TANGENT_ARRAYS:typing.ClassVar[int]

  IMPORT_USE_NAMED_SKIN_BINDS:typing.ClassVar[int]

  IMPORT_DISCARD_MESHES_AND_MATERIALS:typing.ClassVar[int]

  IMPORT_FORCE_DISABLE_MESH_COMPRESSION:typing.ClassVar[int]

  @staticmethod
  def constructor():
    class_ = EditorSceneFormatImporter.construct_without_init()
    class_._ptr = constructor(302,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorSceneFormatImporter.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorSceneFormatImporterWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(302,0, ())


  def generate_wrapper(self):
    return CPPEditorSceneFormatImporterWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = EditorSceneFormatImporter.__new__(EditorSceneFormatImporter)
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(59, ())
      self._ptr = None
  @staticmethod
  def cast(other:'Object'):
    assert other != None # Object to be casted must not be None
    cls = EditorSceneFormatImporter.construct_without_init()
    cls._ptr = CPPEditorSceneFormatImporterWrapper()
  ...
  def _get_extensions(self) -> typing.Union['PackedStringArray']:
    r'''
  ...
  @functools.native_method
  def _import_scene(self, path:'str'   , flags:'int'   , options:'Dictionary'   ) -> typing.Any:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(54,tuple([py_string_path._ptr, flags, options._ptr]))
  ...
  def _get_import_options(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(55,tuple([py_string_path._ptr]))
  ...
  def _get_option_visibility(self, path:'str'   , for_animation:'bool'   , option:'str'   ) -> typing.Union[typing.Any]:
    ...
    _ret = None
    _ret = self._ptr.call_with_return(56,tuple([py_string_path._ptr, for_animation, py_string_option._ptr]))
    return _ret
  ...
  def add_import_option_advanced(self, type:'int'  , name:'str'   , default_value:'object'   , hint:'int'  =0, hint_string:'str' =""  , usage_flags:'int' =6  ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([type, py_string_name._ptr, default_value, hint, py_string_hint_string._ptr, usage_flags]))


register_cast_function('EditorSceneFormatImporter', EditorSceneFormatImporter.cast)
register_class('EditorSceneFormatImporter', EditorSceneFormatImporter)
