...
class RenderData(py4godot_object.Object):
  ...
  def get_render_scene_buffers(self) -> typing.Union['py4godot_renderscenebuffers.RenderSceneBuffers','py4godot_renderscenebuffersextension.RenderSceneBuffersExtension','py4godot_renderscenebuffersrd.RenderSceneBuffersRD']:
    r'''
