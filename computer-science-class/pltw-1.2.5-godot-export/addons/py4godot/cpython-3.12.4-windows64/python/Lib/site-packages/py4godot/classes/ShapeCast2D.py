...
from py4godot.wrappers.wrappers import CPPShapeCast2DWrapper


class ShapeCast2D(py4godot_node2d.Node2D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = ShapeCast2D.construct_without_init()
    class_._ptr = constructor(743,0, ())
    return class_
  @staticmethod
  def new():
    class_ = ShapeCast2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPShapeCast2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(743,0, ())


  def generate_wrapper(self):
    return CPPShapeCast2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = ShapeCast2D.__new__(ShapeCast2D)
  ...
  def cast(other:'Object'):
    ...
    cls = ShapeCast2D.construct_without_init()
    cls._ptr = CPPShapeCast2DWrapper()
  ...
  def set_shape(self, shape:'py4godot_shape2d.Shape2D'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([shape._ptr]))
  ...
  def set_target_position(self, local_point:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([local_point._ptr]))
  ...
  def set_max_results(self, max_results:'int'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([max_results]))
  ...
  def force_shapecast_update(self) -> None:
    ...
    self._ptr.call_with_return(315,tuple([]))
  ...
  def get_collider(self, index:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(316,tuple([index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_collider_rid(self, index:'int'   ) -> typing.Union['RID']:
    ...
    _ret._ptr = self._ptr.call_with_return(317,tuple([index]))
    return _ret
  ...
  def get_collider_shape(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(318,tuple([index]))
    return _ret


  @functools.native_method
  def get_collision_point(self, index:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(319,tuple([index]))
    return _ret


  @functools.native_method
  def get_collision_normal(self, index:'int'   ) -> typing.Union['Vector2']:
    r'''
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(320,tuple([index]))
    return _ret
  ...
  def add_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(323,tuple([rid._ptr]))

  @functools.native_method
  def add_exception(self, node:'py4godot_collisionobject2d.CollisionObject2D'   ) -> None:
    r'''
				Adds a collision exception so the shape does not report collisions with the specified node.
			'''

    assert(not node is None)
    assert isinstance(node, get_class('CollisionObject2D')), 'node must be CollisionObject2D'
    ...
    self._ptr.call_with_return(324,tuple([node._ptr]))
  ...
  def remove_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(325,tuple([rid._ptr]))

  @functools.native_method
  def remove_exception(self, node:'py4godot_collisionobject2d.CollisionObject2D'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(326,tuple([node._ptr]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(328,tuple([mask]))
  ...
  def set_collision_mask_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(330,tuple([layer_number, value]))
  ...
  def get_collision_mask_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(331,tuple([layer_number]))
    return _ret
  ...
  def set_exclude_parent_body(self, mask:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(332,tuple([mask]))
  ...
  def set_collide_with_areas(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(334,tuple([enable]))
  ...
  def set_collide_with_bodies(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(336,tuple([enable]))
...
register_cast_function('ShapeCast2D', ShapeCast2D.cast)
register_class('ShapeCast2D', ShapeCast2D)
