...
from py4godot.wrappers.wrappers import CPPResourceLoaderWrapper

_ResourceLoader_singleton_instance = None
class ThreadLoadStatus:
...
class ResourceLoader(py4godot_object.Object):
  r'''
  ...
  def generate_wrapper(self):
    return CPPResourceLoaderWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = ResourceLoader.__new__(ResourceLoader)
  ...
  def cast(other:'Object'):
    ...
    cls = ResourceLoader.construct_without_init()
    cls._ptr = CPPResourceLoaderWrapper()
  ...
  @staticmethod
  def instance():
    global _ResourceLoader_singleton_instance
    if _ResourceLoader_singleton_instance is None:
      singleton = ResourceLoader()
      singleton._ptr = constructor(705,0, ())
      _ResourceLoader_singleton_instance = singleton
    return _ResourceLoader_singleton_instance

  @functools.native_method
  def load_threaded_request(self, path:'str'   , type_hint:'str' =""  , use_sub_threads:'bool' =False  , cache_mode:'int'  =1) -> typing.Union[int]:
    r'''
    ...
    assert(isinstance(type_hint, (str, String)))
    py_string_type_hint = type_hint if isinstance(type_hint, StringName) else c_utils.py_string_to_string(type_hint)



    _ret:int
    _ret = self._ptr.call_with_return(49,tuple([py_string_path._ptr, py_string_type_hint._ptr, use_sub_threads, cache_mode]))
    return _ret


  @functools.native_method
  def load_threaded_get_status(self, path:'str'   , progress:'Array' = None  ) -> typing.Union[int]:
    r'''
    ...
    _ret:int
    _ret = self._ptr.call_with_return(50,tuple([py_string_path._ptr, progress._ptr]))
    return _ret


  @functools.native_method
  def load_threaded_get(self, path:'str'   ) -> typing.Any:
    r'''
				Returns the resource loaded by `load_threaded_request`.
				If this is called before the loading thread is done (i.e. `load_threaded_get_status` is not `constant THREAD_LOAD_LOADED`), the calling thread will be blocked until the resource has finished loading. However, it's recommended to use `load_threaded_get_status` to known when the load has actually completed.
			'''
    ...
    _ret._ptr = self._ptr.call_with_return(51,tuple([py_string_path._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def load(self, path:'str'   , type_hint:'str' =""  , cache_mode:'int'  =1) -> typing.Any:
    r'''
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Resource
    _ret._ptr = self._ptr.call_with_return(52,tuple([py_string_path._ptr, py_string_type_hint._ptr, cache_mode]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_recognized_extensions_for_type(self, type:'str'   ) -> typing.Union['PackedStringArray']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(53,tuple([py_string_type._ptr]))
    return _ret


  @functools.native_method
  def add_resource_format_loader(self, format_loader:'py4godot_resourceformatloader.ResourceFormatLoader'   , at_front:'bool' =False  ) -> None:
    r'''
    ...
    assert(not format_loader is None)
    assert isinstance(format_loader, get_class('ResourceFormatLoader')), 'format_loader must be ResourceFormatLoader'
    ...
    self._ptr.call_with_return(54,tuple([format_loader._ptr, at_front]))

  @functools.native_method
  def remove_resource_format_loader(self, format_loader:'py4godot_resourceformatloader.ResourceFormatLoader'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(55,tuple([format_loader._ptr]))
  ...
  def set_abort_on_missing_resources(self, abort:'bool'   ) -> None:
    ...
    assert isinstance(abort, bool), 'abort must be bool'
    ...
    self._ptr.call_with_return(56,tuple([abort]))

  @functools.native_method
  def get_dependencies(self, path:'str'   ) -> typing.Union['PackedStringArray']:
    r'''
  ...
  @functools.native_method
  def has_cached(self, path:'str'   ) -> typing.Union[bool]:
    r'''
  ...
  @functools.native_method
  def get_cached_ref(self, path:'str'   ) -> typing.Any:
    r'''
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Resource
    _ret._ptr = self._ptr.call_with_return(59,tuple([py_string_path._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def exists(self, path:'str'   , type_hint:'str' =""  ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(60,tuple([py_string_path._ptr, py_string_type_hint._ptr]))
    return _ret


  @functools.native_method
  def get_resource_uid(self, path:'str'   ) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def list_directory(self, directory_path:'str'   ) -> typing.Union['PackedStringArray']:
    r'''
    ...
    assert(not directory_path is None)
    assert isinstance(directory_path, (str, String)), 'directory_path must be str or String'





    assert(isinstance(directory_path, (str, String)))
    py_string_directory_path = directory_path if isinstance(directory_path, StringName) else c_utils.py_string_to_string(directory_path)

    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(62,tuple([py_string_directory_path._ptr]))
    return _ret



register_cast_function('ResourceLoader', ResourceLoader.cast)
register_class('ResourceLoader', ResourceLoader)
