...
from py4godot.wrappers.wrappers import CPPCollisionObject3DWrapper
...
class CollisionObject3D(py4godot_node3d.Node3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = CollisionObject3D.construct_without_init()
    class_._ptr = constructor(216,0, ())
    return class_
  @staticmethod
  def new():
    class_ = CollisionObject3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCollisionObject3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(216,0, ())


  def generate_wrapper(self):
    return CPPCollisionObject3DWrapper()
  ...
  def construct_without_init():
    cls = CollisionObject3D.__new__(CollisionObject3D)
  ...
  def cast(other:'Object'):
    ...
    cls = CollisionObject3D.construct_without_init()
    cls._ptr = CPPCollisionObject3DWrapper()
  ...
  @property
  def input_ray_pickable(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_ray_pickable()
    return _ret
  @input_ray_pickable.setter
  def input_ray_pickable(self,  value:'bool'):
    self.set_ray_pickable(value)
  @property
  def input_capture_on_drag(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_capture_input_on_drag()
    return _ret
  @input_capture_on_drag.setter
  def input_capture_on_drag(self,  value:'bool'):
    self.set_capture_input_on_drag(value)
  @functools.native_method
  def _input_event(self, camera:'py4godot_camera3d.Camera3D'   , event:'py4godot_inputevent.InputEvent'   , event_position:'Vector3'   , normal:'Vector3'   , shape_idx:'int'   ) -> None:
    r'''
				Receives unhandled `InputEvent`s. `event_position` is the location in world space of the mouse pointer on the surface of the shape with index `shape_idx` and `normal` is the normal vector of the surface at that point. Connect to the `signal input_event` signal to easily pick up these events.
    ...
    assert(not event_position is None)
    assert isinstance(event_position, Vector3), 'event_position must be Vector3'
    ...
    self._ptr.call_with_return(251,tuple([camera._ptr, event._ptr, event_position._ptr, normal._ptr, shape_idx]))
  ...
  def set_collision_layer(self, layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(254,tuple([layer]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(256,tuple([mask]))
  ...
  def set_collision_layer_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(258,tuple([layer_number, value]))
  ...
  def get_collision_layer_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(259,tuple([layer_number]))
    return _ret
  ...
  def set_collision_priority(self, priority:'float'   ) -> None:
    ...
    self._ptr.call_with_return(262,tuple([priority]))
  ...
  def set_ray_pickable(self, ray_pickable:'bool'   ) -> None:
    ...
    self.py__input_ray_pickable = ray_pickable
    ...
    self._ptr.call_with_return(266,tuple([ray_pickable]))
  ...
  def set_capture_input_on_drag(self, enable:'bool'   ) -> None:
    ...
    self.py__input_capture_on_drag = enable
    ...
    self._ptr.call_with_return(268,tuple([enable]))

  @functools.native_method
  def get_capture_input_on_drag(self) -> typing.Union[bool]:
    r''''''
  ...
  def create_shape_owner(self, owner:'py4godot_object.Object'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(271,tuple([owner._ptr]))
    return _ret
  ...
  def remove_shape_owner(self, owner_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(272,tuple([owner_id]))
  ...
  def shape_owner_set_transform(self, owner_id:'int'   , transform:'Transform3D'   ) -> None:
    ...
    self._ptr.call_with_return(274,tuple([owner_id, transform._ptr]))

  @functools.native_method
  def shape_owner_get_transform(self, owner_id:'int'   ) -> typing.Union['Transform3D']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(275,tuple([owner_id]))
    return _ret
  ...
  def shape_owner_get_owner(self, owner_id:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(276,tuple([owner_id]))
  ...
  def shape_owner_set_disabled(self, owner_id:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(277,tuple([owner_id, disabled]))
  ...
  def is_shape_owner_disabled(self, owner_id:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(278,tuple([owner_id]))
    return _ret


  @functools.native_method
  def shape_owner_add_shape(self, owner_id:'int'   , shape:'py4godot_shape3d.Shape3D'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(279,tuple([owner_id, shape._ptr]))
  ...
  def shape_owner_get_shape_count(self, owner_id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(280,tuple([owner_id]))
    return _ret
  ...
  def shape_owner_get_shape(self, owner_id:'int'   , shape_id:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(281,tuple([owner_id, shape_id]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def shape_owner_get_shape_index(self, owner_id:'int'   , shape_id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(282,tuple([owner_id, shape_id]))
    return _ret
  ...
  def shape_owner_remove_shape(self, owner_id:'int'   , shape_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(283,tuple([owner_id, shape_id]))
  ...
  def shape_owner_clear_shapes(self, owner_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(284,tuple([owner_id]))
  ...
  def shape_find_owner(self, shape_index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(285,tuple([shape_index]))
    return _ret



register_cast_function('CollisionObject3D', CollisionObject3D.cast)
register_class('CollisionObject3D', CollisionObject3D)
