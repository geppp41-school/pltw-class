...
import py4godot.classes.RIDTypedArray as py4godot_ridtypedarray 
from py4godot.wrappers.wrappers import CPPNavigationPathQueryParameters3DWrapper
...
class NavigationPathQueryParameters3D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = NavigationPathQueryParameters3D.construct_without_init()
    class_._ptr = constructor(505,0, ())
    return class_
  @staticmethod
  def new():
    class_ = NavigationPathQueryParameters3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPNavigationPathQueryParameters3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(505,0, ())


  def generate_wrapper(self):
    return CPPNavigationPathQueryParameters3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = NavigationPathQueryParameters3D.__new__(NavigationPathQueryParameters3D)
  ...
  def cast(other:'Object'):
    ...
    cls = NavigationPathQueryParameters3D.construct_without_init()
    cls._ptr = CPPNavigationPathQueryParameters3DWrapper()
  ...
  def set_start_position(self, start_position:'Vector3'   ) -> None:
    ...
    assert isinstance(start_position, Vector3), 'start_position must be Vector3'
  ...
  def set_target_position(self, target_position:'Vector3'   ) -> None:
    ...
    assert isinstance(target_position, Vector3), 'target_position must be Vector3'
...
register_cast_function('NavigationPathQueryParameters3D', NavigationPathQueryParameters3D.cast)
register_class('NavigationPathQueryParameters3D', NavigationPathQueryParameters3D)
