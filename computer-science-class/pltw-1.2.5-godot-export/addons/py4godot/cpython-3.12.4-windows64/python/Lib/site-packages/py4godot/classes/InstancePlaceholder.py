...
from py4godot.wrappers.wrappers import CPPInstancePlaceholderWrapper


class InstancePlaceholder(py4godot_node.Node):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = InstancePlaceholder.construct_without_init()
    class_._ptr = constructor(431,0, ())
    return class_
  @staticmethod
  def new():
    class_ = InstancePlaceholder.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPInstancePlaceholderWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(431,0, ())


  def generate_wrapper(self):
    return CPPInstancePlaceholderWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = InstancePlaceholder.__new__(InstancePlaceholder)
  ...
  def cast(other:'Object'):
    ...
    cls = InstancePlaceholder.construct_without_init()
    cls._ptr = CPPInstancePlaceholderWrapper()
  ...
  def get_stored_values(self, with_order:'bool' =False  ) -> typing.Union['Dictionary']:
    r'''
    ...
    assert isinstance(with_order, bool), 'with_order must be bool'
    ...
    _ret._ptr = self._ptr.call_with_return(180,tuple([with_order]))
    return _ret


  @functools.native_method
  def create_instance(self, replace:'bool' =False  , custom_scene:'py4godot_packedscene.PackedScene' = None  ) -> typing.Any:
    r'''
    ...
    if custom_scene is None:
      custom_scene = c_utils.empty_object
    ...
    _ret._ptr = self._ptr.call_with_return(181,tuple([replace, custom_scene._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_instance_path(self) -> typing.Union[str]:
    r'''
...
register_cast_function('InstancePlaceholder', InstancePlaceholder.cast)
register_class('InstancePlaceholder', InstancePlaceholder)
