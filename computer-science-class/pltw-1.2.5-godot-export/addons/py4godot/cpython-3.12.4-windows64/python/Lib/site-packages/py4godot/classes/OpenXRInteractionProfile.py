...
class OpenXRInteractionProfile(py4godot_resource.Resource):
  ...
  @property
  def binding_modifiers(self) -> typing.Union['py4godot_openxrdpadbindingmodifier.OpenXRDpadBindingModifier','py4godot_openxripbindingmodifier.OpenXRIPBindingModifier']:
    r''''''
  ...
  @functools.native_method
  def get_binding_modifier(self, index:'int'   ) -> typing.Union['py4godot_openxrdpadbindingmodifier.OpenXRDpadBindingModifier','py4godot_openxripbindingmodifier.OpenXRIPBindingModifier']:
    r''''''
