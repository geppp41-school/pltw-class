...
'''
  ...
  @functools.native_method
  def _body_get_direct_state(self, body:'RID'   ) -> typing.Union['py4godot_physicsdirectbodystate3dextension.PhysicsDirectBodyState3DExtension','py4godot_physicsdirectbodystate3d.PhysicsDirectBodyState3D']:
    r'''
'''
