...
from py4godot.wrappers.wrappers import CPPCSGSphere3DWrapper


class CSGSphere3D(py4godot_csgprimitive3d.CSGPrimitive3D):
  r''''''

  @staticmethod
  def constructor():
    class_ = CSGSphere3D.construct_without_init()
    class_._ptr = constructor(185,0, ())
    return class_
  @staticmethod
  def new():
    class_ = CSGSphere3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCSGSphere3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(185,0, ())


  def generate_wrapper(self):
    return CPPCSGSphere3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = CSGSphere3D.__new__(CSGSphere3D)
  ...
  def cast(other:'Object'):
    ...
    cls = CSGSphere3D.construct_without_init()
    cls._ptr = CPPCSGSphere3DWrapper()
  ...
  def set_radial_segments(self, radial_segments:'int'   ) -> None:
    ...
    self._ptr.call_with_return(324,tuple([radial_segments]))
  ...
  def set_rings(self, rings:'int'   ) -> None:
    ...
    self._ptr.call_with_return(326,tuple([rings]))
  ...
  def set_smooth_faces(self, smooth_faces:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(328,tuple([smooth_faces]))
...
register_cast_function('CSGSphere3D', CSGSphere3D.cast)
register_class('CSGSphere3D', CSGSphere3D)
