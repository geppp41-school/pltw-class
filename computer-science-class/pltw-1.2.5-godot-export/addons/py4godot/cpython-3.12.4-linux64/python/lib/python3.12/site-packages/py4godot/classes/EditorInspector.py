...
from py4godot.wrappers.wrappers import CPPEditorInspectorWrapper


class EditorInspector(py4godot_scrollcontainer.ScrollContainer):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = EditorInspector.construct_without_init()
    class_._ptr = constructor(289,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorInspector.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorInspectorWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(289,0, ())


  def generate_wrapper(self):
    return CPPEditorInspectorWrapper()
  def init_signals(self):
    super().init_signals()
    property_selected_name = utils.py_string_to_string_name("property_selected")
    self.property_selected = signals.BuiltinSignal(self, property_selected_name)
    ...
    property_edited_name = utils.py_string_to_string_name("property_edited")
    self.property_edited = signals.BuiltinSignal(self, property_edited_name)
    property_toggled_name = utils.py_string_to_string_name("property_toggled")
    self.property_toggled = signals.BuiltinSignal(self, property_toggled_name)
    edited_object_changed_name = utils.py_string_to_string_name("edited_object_changed")
    self.edited_object_changed = signals.BuiltinSignal(self, edited_object_changed_name)
    restart_requested_name = utils.py_string_to_string_name("restart_requested")
    self.restart_requested = signals.BuiltinSignal(self, restart_requested_name)

  @staticmethod
  def construct_without_init():
    cls = EditorInspector.__new__(EditorInspector)
  ...
  def cast(other:'Object'):
    ...
    cls = EditorInspector.construct_without_init()
    cls._ptr = CPPEditorInspectorWrapper()
  ...
  def edit(self, object_:'py4godot_object.Object'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(458,tuple([object_._ptr]))

  @functools.native_method
  def get_selected_path(self) -> typing.Union[str]:
    r'''
  ...
  @staticmethod
  def instantiate_property_editor(object_:'py4godot_object.Object'   , type:'int'  , path:'str'   , hint:'int'  , hint_text:'str'   , usage:'int'   , wide:'bool' =False  ) -> typing.Union['py4godot_editorproperty.EditorProperty']:
    r'''
    ...
    assert(not hint_text is None)
    assert isinstance(hint_text, (str, String)), 'hint_text must be str or String'
    ...
    assert(isinstance(hint_text, (str, String)))
    py_string_hint_text = hint_text if isinstance(hint_text, StringName) else c_utils.py_string_to_string(hint_text)



    _ret = classes.Object.Object.construct_without_init() #Smart casted to: EditorProperty
    _ret._ptr = static_method(289,2,tuple([object_._ptr, type, py_string_path._ptr, hint, py_string_hint_text._ptr, usage, wide]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None



register_cast_function('EditorInspector', EditorInspector.cast)
register_class('EditorInspector', EditorInspector)
