...
from py4godot.wrappers.wrappers import CPPPhysicsTestMotionResult2DWrapper


class PhysicsTestMotionResult2D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsTestMotionResult2D.construct_without_init()
    class_._ptr = constructor(615,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsTestMotionResult2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsTestMotionResult2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(615,0, ())


  def generate_wrapper(self):
    return CPPPhysicsTestMotionResult2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsTestMotionResult2D.__new__(PhysicsTestMotionResult2D)
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(66, ())
      self._ptr = None
  @staticmethod
  def cast(other:'Object'):
    assert other != None # Object to be casted must not be None
    cls = PhysicsTestMotionResult2D.construct_without_init()
    cls._ptr = CPPPhysicsTestMotionResult2DWrapper()
  ...
  def get_travel(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def get_remainder(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def get_collider_velocity(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def get_collider_id(self) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def get_collision_local_shape(self) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def get_collision_depth(self) -> typing.Union[float]:
    r'''
...
register_cast_function('PhysicsTestMotionResult2D', PhysicsTestMotionResult2D.cast)
register_class('PhysicsTestMotionResult2D', PhysicsTestMotionResult2D)
