...
class FontVariation(py4godot_font.Font):
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(125, ())
      self._ptr = None
  @staticmethod
  ...
  @property
  def base_font(self) -> typing.Union['py4godot_font.Font','py4godot_systemfont.SystemFont','typing.Self','py4godot_fontfile.FontFile']:
    r''''''
  ...
  @functools.native_method
  def get_base_font(self) -> typing.Union['py4godot_font.Font','py4godot_systemfont.SystemFont','typing.Self','py4godot_fontfile.FontFile']:
    r''''''
