...
from py4godot.wrappers.wrappers import CPPRayCast2DWrapper


class RayCast2D(py4godot_node2d.Node2D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = RayCast2D.construct_without_init()
    class_._ptr = constructor(663,0, ())
    return class_
  @staticmethod
  def new():
    class_ = RayCast2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPRayCast2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(663,0, ())


  def generate_wrapper(self):
    return CPPRayCast2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = RayCast2D.__new__(RayCast2D)
  ...
  def cast(other:'Object'):
    ...
    cls = RayCast2D.construct_without_init()
    cls._ptr = CPPRayCast2DWrapper()
  ...
  def set_target_position(self, local_point:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([local_point._ptr]))
  ...
  @functools.native_method
  def get_collision_point(self) -> typing.Union['Vector2']:
    r'''
  ...
  @functools.native_method
  def get_collision_normal(self) -> typing.Union['Vector2']:
    r'''
  ...
  def add_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(314,tuple([rid._ptr]))
  ...
  def add_exception(self, node:'py4godot_collisionobject2d.CollisionObject2D'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([node._ptr]))
  ...
  def remove_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(316,tuple([rid._ptr]))
  ...
  def remove_exception(self, node:'py4godot_collisionobject2d.CollisionObject2D'   ) -> None:
    ...
    self._ptr.call_with_return(317,tuple([node._ptr]))
  ...
  def clear_exceptions(self) -> None:
    ...
    self._ptr.call_with_return(318,tuple([]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(319,tuple([mask]))
  ...
  def set_collision_mask_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(321,tuple([layer_number, value]))
  ...
  def get_collision_mask_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(322,tuple([layer_number]))
    return _ret
  ...
  def set_exclude_parent_body(self, mask:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(323,tuple([mask]))
  ...
  def set_collide_with_areas(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(325,tuple([enable]))
  ...
  def set_hit_from_inside(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(329,tuple([enable]))
...
register_cast_function('RayCast2D', RayCast2D.cast)
register_class('RayCast2D', RayCast2D)
