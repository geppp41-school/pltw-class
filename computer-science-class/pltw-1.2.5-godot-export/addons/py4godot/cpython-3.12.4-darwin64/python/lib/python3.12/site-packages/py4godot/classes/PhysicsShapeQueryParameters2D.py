...
import py4godot.classes.RIDTypedArray as py4godot_ridtypedarray 
from py4godot.wrappers.wrappers import CPPPhysicsShapeQueryParameters2DWrapper


class PhysicsShapeQueryParameters2D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsShapeQueryParameters2D.construct_without_init()
    class_._ptr = constructor(611,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsShapeQueryParameters2D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsShapeQueryParameters2DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(611,0, ())


  def generate_wrapper(self):
    return CPPPhysicsShapeQueryParameters2DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsShapeQueryParameters2D.__new__(PhysicsShapeQueryParameters2D)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsShapeQueryParameters2D.construct_without_init()
    cls._ptr = CPPPhysicsShapeQueryParameters2DWrapper()
...
register_cast_function('PhysicsShapeQueryParameters2D', PhysicsShapeQueryParameters2D.cast)
register_class('PhysicsShapeQueryParameters2D', PhysicsShapeQueryParameters2D)
