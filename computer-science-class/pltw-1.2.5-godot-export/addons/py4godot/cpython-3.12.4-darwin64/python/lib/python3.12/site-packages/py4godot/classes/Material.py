...
from py4godot.wrappers.wrappers import CPPMaterialWrapper


class Material(py4godot_resource.Resource):
  r'''
	...
	'''
  RENDER_PRIORITY_MAX:typing.ClassVar[int]

  RENDER_PRIORITY_MIN:typing.ClassVar[int]

  @staticmethod
  def constructor():
    class_ = Material.construct_without_init()
    class_._ptr = constructor(467,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Material.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPMaterialWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(467,0, ())


  def generate_wrapper(self):
    return CPPMaterialWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = Material.__new__(Material)
  ...
  def cast(other:'Object'):
    ...
    cls = Material.construct_without_init()
    cls._ptr = CPPMaterialWrapper()
  ...
  @property
  def next_pass(self) -> typing.Any:
    r''''''
    _ret = self. get_next_pass()
    return _ret
  @next_pass.setter
  def next_pass(self,  value:'py4godot_object.Object'):
    self.set_next_pass(value)
  @functools.native_method
  def _get_shader_rid(self) -> typing.Union['RID']:
    r'''
  ...
  @functools.native_method
  def _get_shader_mode(self) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def _can_do_next_pass(self) -> typing.Union[bool]:
    r'''
  ...
  @functools.native_method
  def _can_use_render_priority(self) -> typing.Union[bool]:
    r'''
  ...
  def set_next_pass(self, next_pass:'Material'   ) -> None:
    ...
    assert(not next_pass is None)
    assert isinstance(next_pass, get_class('Material')), 'next_pass must be Material'


    self.py__next_pass = next_pass
    ...
    self._ptr.call_with_return(81,tuple([next_pass._ptr]))

  @functools.native_method
  def get_next_pass(self) -> typing.Any:
    r''''''




    _ret = Material.construct_without_init()
  ...
  def set_render_priority(self, priority:'int'   ) -> None:
    ...
    self._ptr.call_with_return(83,tuple([priority]))
...
register_cast_function('Material', Material.cast)
