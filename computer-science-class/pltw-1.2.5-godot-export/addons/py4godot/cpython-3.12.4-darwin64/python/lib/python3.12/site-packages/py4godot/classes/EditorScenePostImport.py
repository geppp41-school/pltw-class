...
from py4godot.wrappers.wrappers import CPPEditorScenePostImportWrapper


class EditorScenePostImport(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = EditorScenePostImport.construct_without_init()
    class_._ptr = constructor(307,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorScenePostImport.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorScenePostImportWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(307,0, ())


  def generate_wrapper(self):
    return CPPEditorScenePostImportWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = EditorScenePostImport.__new__(EditorScenePostImport)
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(55, ())
      self._ptr = None
  @staticmethod
  def cast(other:'Object'):
    assert other != None # Object to be casted must not be None
    cls = EditorScenePostImport.construct_without_init()
    cls._ptr = CPPEditorScenePostImportWrapper()
  ...
  def _post_import(self, scene:'py4godot_node.Node'   ) -> typing.Any:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(53,tuple([scene._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_source_file(self) -> typing.Union[str]:
    r'''
...
register_cast_function('EditorScenePostImport', EditorScenePostImport.cast)
register_class('EditorScenePostImport', EditorScenePostImport)
