...
from py4godot.wrappers.wrappers import CPPEditorResourcePickerWrapper


class EditorResourcePicker(py4godot_hboxcontainer.HBoxContainer):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = EditorResourcePicker.construct_without_init()
    class_._ptr = constructor(298,0, ())
    return class_
  @staticmethod
  def new():
    class_ = EditorResourcePicker.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPEditorResourcePickerWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(298,0, ())


  def generate_wrapper(self):
    return CPPEditorResourcePickerWrapper()
  def init_signals(self):
    ...
    resource_changed_name = utils.py_string_to_string_name("resource_changed")
    self.resource_changed = signals.BuiltinSignal(self, resource_changed_name)

  @staticmethod
  def construct_without_init():
    cls = EditorResourcePicker.__new__(EditorResourcePicker)
  ...
  def cast(other:'Object'):
    ...
    cls = EditorResourcePicker.construct_without_init()
    cls._ptr = CPPEditorResourcePickerWrapper()
  ...
  @property
  def base_type(self) -> typing.Union[str]:
    r''''''
    _ret = self. get_base_type()
    return _ret
  @base_type.setter
  def base_type(self,  value:'str'):
    self.set_base_type(value)
  @property
  def edited_resource(self) -> typing.Any:
    r''''''
    _ret = self. get_edited_resource()
    return _ret
  @edited_resource.setter
  def edited_resource(self,  value:'py4godot_object.Object'):
    self.set_edited_resource(value)
  @property
  ...
  def _set_create_options(self, menu_node:'py4godot_object.Object'   ) -> None:
    r'''
    ...
    assert(not menu_node is None)
    assert isinstance(menu_node, get_class('Object')), 'menu_node must be Object'
    ...
    self._ptr.call_with_return(442,tuple([menu_node._ptr]))

  @functools.native_method
  def _handle_menu_selected(self, id:'int'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(443,tuple([id]))
    return _ret
  ...
  def set_base_type(self, base_type:'str'   ) -> None:
    ...
    assert isinstance(base_type, (str, String)), 'base_type must be str or String'


    self.py__base_type = base_type



    assert(isinstance(base_type, (str, String)))
    py_string_base_type = base_type if isinstance(base_type, StringName) else c_utils.py_string_to_string(base_type)

    py__string_base_type = utils.py_string_to_string(base_type)
    py__string_base_type.shouldBeDeleted = False


    self._ptr.call_with_return(444,tuple([py__string_base_type._ptr]))

  @functools.native_method
  def get_base_type(self) -> typing.Union[str]:
    r''''''
  ...
  @functools.native_method
  def get_allowed_types(self) -> typing.Union['PackedStringArray']:
    r'''
  ...
  @functools.native_method
  def set_edited_resource(self, resource:'py4godot_resource.Resource'   ) -> None:
    r''''''
    ...
    self.py__edited_resource = resource
    ...
    self._ptr.call_with_return(447,tuple([resource._ptr]))

  @functools.native_method
  def get_edited_resource(self) -> typing.Any:
    r''''''
  ...
  def set_toggle_mode(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(449,tuple([enable]))
  ...
  def set_toggle_pressed(self, pressed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(451,tuple([pressed]))
  ...
  def set_editable(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(452,tuple([enable]))
...
register_cast_function('EditorResourcePicker', EditorResourcePicker.cast)
register_class('EditorResourcePicker', EditorResourcePicker)
