...
import py4godot.classes.RIDTypedArray as py4godot_ridtypedarray 
from py4godot.wrappers.wrappers import CPPPhysicsPointQueryParameters3DWrapper


class PhysicsPointQueryParameters3D(py4godot_refcounted.RefCounted):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsPointQueryParameters3D.construct_without_init()
    class_._ptr = constructor(601,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsPointQueryParameters3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsPointQueryParameters3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(601,0, ())


  def generate_wrapper(self):
    return CPPPhysicsPointQueryParameters3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsPointQueryParameters3D.__new__(PhysicsPointQueryParameters3D)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsPointQueryParameters3D.construct_without_init()
    cls._ptr = CPPPhysicsPointQueryParameters3DWrapper()
  ...
  def set_collision_mask(self, collision_mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(55,tuple([collision_mask]))
  ...
  def set_exclude(self, exclude:'py4godot_ridtypedarray.RIDTypedArray'   ) -> None:
    ...
    self._ptr.call_with_return(57,tuple([exclude._ptr]))
  ...
  def set_collide_with_bodies(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(59,tuple([enable]))
...
register_cast_function('PhysicsPointQueryParameters3D', PhysicsPointQueryParameters3D.cast)
register_class('PhysicsPointQueryParameters3D', PhysicsPointQueryParameters3D)
