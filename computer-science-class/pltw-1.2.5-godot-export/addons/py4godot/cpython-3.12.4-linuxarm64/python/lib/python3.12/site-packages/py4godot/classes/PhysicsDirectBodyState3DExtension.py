...
from py4godot.wrappers.wrappers import CPPPhysicsDirectBodyState3DExtensionWrapper


class PhysicsDirectBodyState3DExtension(py4godot_physicsdirectbodystate3d.PhysicsDirectBodyState3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = PhysicsDirectBodyState3DExtension.construct_without_init()
    class_._ptr = constructor(594,0, ())
    return class_
  @staticmethod
  def new():
    class_ = PhysicsDirectBodyState3DExtension.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPPhysicsDirectBodyState3DExtensionWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(594,0, ())


  def generate_wrapper(self):
    return CPPPhysicsDirectBodyState3DExtensionWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = PhysicsDirectBodyState3DExtension.__new__(PhysicsDirectBodyState3DExtension)
  ...
  def cast(other:'Object'):
    ...
    cls = PhysicsDirectBodyState3DExtension.construct_without_init()
    cls._ptr = CPPPhysicsDirectBodyState3DExtensionWrapper()
  ...
  def _get_total_gravity(self) -> typing.Union['Vector3']:
    r'''
'''
  ...
  @functools.native_method
  def _get_total_linear_damp(self) -> typing.Union[float]:
    r'''
'''
  ...
  @functools.native_method
  def _get_total_angular_damp(self) -> typing.Union[float]:
    r'''
'''
  ...
  @functools.native_method
  def _get_center_of_mass(self) -> typing.Union['Vector3']:
    r'''
'''
  ...
  @functools.native_method
  def _get_center_of_mass_local(self) -> typing.Union['Vector3']:
    r'''
'''
  ...
  @functools.native_method
  def _get_principal_inertia_axes(self) -> typing.Union['Basis']:
    r'''
'''
  ...
  @functools.native_method
  def _get_inverse_mass(self) -> typing.Union[float]:
    r'''
'''
  ...
  @functools.native_method
  def _get_inverse_inertia(self) -> typing.Union['Vector3']:
    r'''
'''
  ...
  @functools.native_method
  def _get_inverse_inertia_tensor(self) -> typing.Union['Basis']:
    r'''
'''
...
'''
  ...
  @functools.native_method
  def _get_linear_velocity(self) -> typing.Union['Vector3']:
    r'''
'''
...
'''
  ...
  @functools.native_method
  def _get_angular_velocity(self) -> typing.Union['Vector3']:
    r'''
'''
...
'''
    ...
    self._ptr.call_with_return(112,tuple([transform._ptr]))

  @functools.native_method
  def _get_transform(self) -> typing.Union['Transform3D']:
    r'''
'''
  ...
  @functools.native_method
  def _get_velocity_at_local_position(self, local_position:'Vector3'   ) -> typing.Union['Vector3']:
    r'''
'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(114,tuple([local_position._ptr]))
    return _ret
...
'''
    ...
    self._ptr.call_with_return(115,tuple([impulse._ptr]))
...
'''
    ...
    self._ptr.call_with_return(116,tuple([impulse._ptr, position._ptr]))
...
'''
    ...
    self._ptr.call_with_return(117,tuple([impulse._ptr]))
...
'''
    ...
    self._ptr.call_with_return(118,tuple([force._ptr]))
...
'''
    ...
    self._ptr.call_with_return(119,tuple([force._ptr, position._ptr]))
...
'''
    ...
    self._ptr.call_with_return(120,tuple([torque._ptr]))
...
'''
    ...
    self._ptr.call_with_return(121,tuple([force._ptr]))
...
'''
    ...
    self._ptr.call_with_return(122,tuple([force._ptr, position._ptr]))
...
'''
    ...
    self._ptr.call_with_return(123,tuple([torque._ptr]))
...
'''
    ...
    self._ptr.call_with_return(124,tuple([force._ptr]))

  @functools.native_method
  def _get_constant_force(self) -> typing.Union['Vector3']:
    r'''
'''
...
'''
    ...
    self._ptr.call_with_return(126,tuple([torque._ptr]))

  @functools.native_method
  def _get_constant_torque(self) -> typing.Union['Vector3']:
    r'''
'''
...
'''
    ...
    self._ptr.call_with_return(128,tuple([enabled]))

  @functools.native_method
  def _is_sleeping(self) -> typing.Union[bool]:
    r'''
'''
  ...
  @functools.native_method
  def _set_collision_layer(self, layer:'int'   ) -> None:
    r'''
'''
    ...
    self._ptr.call_with_return(130,tuple([layer]))

  @functools.native_method
  def _get_collision_layer(self) -> typing.Union[int]:
    r'''
'''
  ...
  @functools.native_method
  def _set_collision_mask(self, mask:'int'   ) -> None:
    r'''
'''
    ...
    self._ptr.call_with_return(132,tuple([mask]))

  @functools.native_method
  def _get_collision_mask(self) -> typing.Union[int]:
    r'''
'''
  ...
  @functools.native_method
  def _get_contact_count(self) -> typing.Union[int]:
    r'''
'''
  ...
  @functools.native_method
  def _get_contact_local_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
'''

    assert isinstance(contact_idx, (int, float)), 'contact_idx must be int or float'
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(135,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_local_normal(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(136,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_impulse(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(137,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_local_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    r'''
'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(138,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_local_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(139,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_collider(self, contact_idx:'int'   ) -> typing.Union['RID']:
    r'''
'''
    ...
    _ret._ptr = self._ptr.call_with_return(140,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_collider_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(141,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_collider_id(self, contact_idx:'int'   ) -> typing.Union[int]:
    r'''
'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(142,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_collider_object(self, contact_idx:'int'   ) -> typing.Any:
    r'''
'''
    ...
    _ret._ptr = self._ptr.call_with_return(143,tuple([contact_idx]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def _get_contact_collider_shape(self, contact_idx:'int'   ) -> typing.Union[int]:
    r'''
'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(144,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_contact_collider_velocity_at_position(self, contact_idx:'int'   ) -> typing.Union['Vector3']:
    r'''
'''
    ...
    _ret = Vector3.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(145,tuple([contact_idx]))
    return _ret


  @functools.native_method
  def _get_step(self) -> typing.Union[float]:
    r'''
'''
...
'''
    ...
    self._ptr.call_with_return(147,tuple([]))

  @functools.native_method
  def _get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate3d.PhysicsDirectSpaceState3D','py4godot_physicsdirectspacestate3dextension.PhysicsDirectSpaceState3DExtension']:
    r'''
'''
...
register_cast_function('PhysicsDirectBodyState3DExtension', PhysicsDirectBodyState3DExtension.cast)
register_class('PhysicsDirectBodyState3DExtension', PhysicsDirectBodyState3DExtension)
