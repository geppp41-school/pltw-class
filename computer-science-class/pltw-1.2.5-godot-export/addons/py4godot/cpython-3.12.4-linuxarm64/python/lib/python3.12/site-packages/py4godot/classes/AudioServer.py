...
class AudioServer(py4godot_object.Object):
  ...
  @functools.native_method
  def get_bus_effect_instance(self, bus_idx:'int'   , effect_idx:'int'   , channel:'int' =0  ) -> typing.Union['py4godot_audioeffectspectrumanalyzerinstance.AudioEffectSpectrumAnalyzerInstance','py4godot_audioeffectinstance.AudioEffectInstance']:
    r'''
