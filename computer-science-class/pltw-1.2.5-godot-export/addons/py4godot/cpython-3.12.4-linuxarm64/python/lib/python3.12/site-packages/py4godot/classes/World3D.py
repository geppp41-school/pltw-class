...
class World3D(py4godot_resource.Resource):
  ...
  @functools.native_method
  def get_camera_attributes(self) -> typing.Union['py4godot_cameraattributesphysical.CameraAttributesPhysical','py4godot_cameraattributespractical.CameraAttributesPractical','py4godot_cameraattributes.CameraAttributes']:
    r''''''
