...
from py4godot.wrappers.wrappers import CPPVisualShaderNodeRerouteWrapper


class VisualShaderNodeReroute(py4godot_visualshadernode.VisualShaderNode):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = VisualShaderNodeReroute.construct_without_init()
    class_._ptr = constructor(939,0, ())
    return class_
  @staticmethod
  def new():
    class_ = VisualShaderNodeReroute.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPVisualShaderNodeRerouteWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(939,0, ())


  def generate_wrapper(self):
    return CPPVisualShaderNodeRerouteWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = VisualShaderNodeReroute.__new__(VisualShaderNodeReroute)
  ...
  def cast(other:'Object'):
    ...
    cls = VisualShaderNodeReroute.construct_without_init()
    cls._ptr = CPPVisualShaderNodeRerouteWrapper()
  ...
  @property
  def port_type(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_port_type()
    return _ret
  @port_type.setter
  def port_type(self,  value:'int'):
    self._set_port_type(value)
  @functools.native_method
  def get_port_type(self) -> typing.Union[int]:
    r'''
...
register_cast_function('VisualShaderNodeReroute', VisualShaderNodeReroute.cast)
register_class('VisualShaderNodeReroute', VisualShaderNodeReroute)
