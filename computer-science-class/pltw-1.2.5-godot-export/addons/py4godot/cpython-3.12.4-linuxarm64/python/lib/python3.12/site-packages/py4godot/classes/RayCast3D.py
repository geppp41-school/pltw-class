...
from py4godot.wrappers.wrappers import CPPRayCast3DWrapper


class RayCast3D(py4godot_node3d.Node3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = RayCast3D.construct_without_init()
    class_._ptr = constructor(664,0, ())
    return class_
  @staticmethod
  def new():
    class_ = RayCast3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPRayCast3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(664,0, ())


  def generate_wrapper(self):
    return CPPRayCast3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = RayCast3D.__new__(RayCast3D)
  ...
  def cast(other:'Object'):
    ...
    cls = RayCast3D.construct_without_init()
    cls._ptr = CPPRayCast3DWrapper()
  ...
  @property
  def debug_shape_thickness(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_debug_shape_thickness()
    return _ret
  @debug_shape_thickness.setter
  def debug_shape_thickness(self,  value:'int'):
    self.set_debug_shape_thickness(value)
  ...
  def set_target_position(self, local_point:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(253,tuple([local_point._ptr]))
  ...
  @functools.native_method
  def get_collider(self) -> typing.Any:
    r'''
  ...
  @functools.native_method
  def get_collider_rid(self) -> typing.Union['RID']:
    r'''
  ...
  @functools.native_method
  def get_collider_shape(self) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def get_collision_point(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_collision_normal(self) -> typing.Union['Vector3']:
    r'''
  ...
  @functools.native_method
  def get_collision_face_index(self) -> typing.Union[int]:
    r'''
  ...
  def add_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(263,tuple([rid._ptr]))
  ...
  def add_exception(self, node:'py4godot_collisionobject3d.CollisionObject3D'   ) -> None:
    ...
    self._ptr.call_with_return(264,tuple([node._ptr]))
  ...
  def remove_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(265,tuple([rid._ptr]))
  ...
  def remove_exception(self, node:'py4godot_collisionobject3d.CollisionObject3D'   ) -> None:
    ...
    self._ptr.call_with_return(266,tuple([node._ptr]))
  ...
  def clear_exceptions(self) -> None:
    ...
    self._ptr.call_with_return(267,tuple([]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(268,tuple([mask]))
  ...
  def set_collision_mask_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(270,tuple([layer_number, value]))
  ...
  def get_collision_mask_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(271,tuple([layer_number]))
    return _ret
  ...
  def set_exclude_parent_body(self, mask:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(272,tuple([mask]))
  ...
  def set_collide_with_bodies(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(276,tuple([enable]))
  ...
  def set_hit_from_inside(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(278,tuple([enable]))
  ...
  def set_debug_shape_custom_color(self, debug_shape_custom_color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(282,tuple([debug_shape_custom_color._ptr]))
  ...
  def set_debug_shape_thickness(self, debug_shape_thickness:'int'   ) -> None:
    ...
    assert isinstance(debug_shape_thickness, (int, float)), 'debug_shape_thickness must be int or float'


    self.py__debug_shape_thickness = debug_shape_thickness
    ...
    self._ptr.call_with_return(284,tuple([debug_shape_thickness]))

  @functools.native_method
  def get_debug_shape_thickness(self) -> typing.Union[int]:
    r''''''
...
register_cast_function('RayCast3D', RayCast3D.cast)
register_class('RayCast3D', RayCast3D)
