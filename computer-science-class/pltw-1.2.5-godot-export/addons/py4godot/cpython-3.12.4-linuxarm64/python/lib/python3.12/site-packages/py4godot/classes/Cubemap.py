...
from py4godot.wrappers.wrappers import CPPCubemapWrapper


class Cubemap(py4godot_imagetexturelayered.ImageTextureLayered):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = Cubemap.construct_without_init()
    class_._ptr = constructor(246,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Cubemap.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPCubemapWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(246,0, ())


  def generate_wrapper(self):
    return CPPCubemapWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = Cubemap.__new__(Cubemap)
  ...
  def cast(other:'Object'):
    ...
    cls = Cubemap.construct_without_init()
    cls._ptr = CPPCubemapWrapper()
...
register_cast_function('Cubemap', Cubemap.cast)
register_class('Cubemap', Cubemap)
