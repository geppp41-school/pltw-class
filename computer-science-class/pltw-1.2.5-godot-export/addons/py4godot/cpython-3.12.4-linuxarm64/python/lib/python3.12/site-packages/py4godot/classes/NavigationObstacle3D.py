...
from py4godot.wrappers.wrappers import CPPNavigationObstacle3DWrapper


class NavigationObstacle3D(py4godot_node3d.Node3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = NavigationObstacle3D.construct_without_init()
    class_._ptr = constructor(503,0, ())
    return class_
  @staticmethod
  def new():
    class_ = NavigationObstacle3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPNavigationObstacle3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(503,0, ())


  def generate_wrapper(self):
    return CPPNavigationObstacle3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = NavigationObstacle3D.__new__(NavigationObstacle3D)
  ...
  def cast(other:'Object'):
    ...
    cls = NavigationObstacle3D.construct_without_init()
    cls._ptr = CPPNavigationObstacle3DWrapper()
  ...
  def set_radius(self, radius:'float'   ) -> None:
    ...
    self._ptr.call_with_return(256,tuple([radius]))
  ...
  def set_height(self, height:'float'   ) -> None:
    ...
    self._ptr.call_with_return(258,tuple([height]))
  ...
  def set_velocity(self, velocity:'Vector3'   ) -> None:
    ...
    self._ptr.call_with_return(260,tuple([velocity._ptr]))
  ...
  def set_vertices(self, vertices:'PackedVector3Array'   ) -> None:
    ...
    self._ptr.call_with_return(262,tuple([vertices._ptr]))
  ...
  def set_avoidance_layers(self, layers:'int'   ) -> None:
    ...
    self._ptr.call_with_return(264,tuple([layers]))
  ...
  def set_carve_navigation_mesh(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(272,tuple([enabled]))
...
register_cast_function('NavigationObstacle3D', NavigationObstacle3D.cast)
register_class('NavigationObstacle3D', NavigationObstacle3D)
