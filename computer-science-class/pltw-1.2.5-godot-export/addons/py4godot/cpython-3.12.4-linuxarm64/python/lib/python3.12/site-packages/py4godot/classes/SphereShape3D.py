...
from py4godot.wrappers.wrappers import CPPSphereShape3DWrapper


class SphereShape3D(py4godot_shape3d.Shape3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = SphereShape3D.construct_without_init()
    class_._ptr = constructor(769,0, ())
    return class_
  @staticmethod
  def new():
    class_ = SphereShape3D.construct_without_init()
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPSphereShape3DWrapper()
    self.casted_from = None
    if c_utils.shouldCreateObject:
      self._ptr = constructor(769,0, ())


  def generate_wrapper(self):
    return CPPSphereShape3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = SphereShape3D.__new__(SphereShape3D)
  ...
  def cast(other:'Object'):
    ...
    cls = SphereShape3D.construct_without_init()
    cls._ptr = CPPSphereShape3DWrapper()
...
register_cast_function('SphereShape3D', SphereShape3D.cast)
register_class('SphereShape3D', SphereShape3D)
